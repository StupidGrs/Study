...
namespace RetirementStudio._TestScripts_2019_Oct_CA
{
    ...
    public class CA003_CN
    {
        ...
        public string sOutputFunding_Valuation2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_CA_Benchmark_3\Production\Funding\valuation 12-31-2008\7.7_20200713_QA1Baseline\";
        public string sOutputAccounting_Valuation2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_CA_Benchmark_3\Production\Accounting\Valuation 12-31-2008\7.7_20200713_QA1Baseline\";
        ...
        public void test_CA003_CN()
        {
            ...
            #region Funding - Valuation2008 - add service and Participant Dataset
            ...
            _gLib._MsgBox("", "please delete the existed conversion service");
            ...
            _gLib._MsgBox("", "check: " + Environment.NewLine + "CostMethod -> Traditional Unit Credit- if no then create a bug");
            _gLib._MsgBox("", "check: " + Environment.NewLine + "_BenefitsToInclude -> row 2- 'Solvencybenefit' was un-checked");
            _gLib._MsgBox("", "check: " + Environment.NewLine + "_ResultsForStatisticsForExpected_Grid_IR->  SalBenefitFormula");
            pMain._Home_ToolbarClick_Top(true);
            ...
            _gLib._MsgBox("", "please delete the existed service");
            ...
            _gLib._MsgBox("", "make sure row7-Solvencybenefit is un-checked");
