...
{
    /// <summary>
    /// Summary description for CA002_CN
    /// </summary>
    [CodedUITest]
    public class CA002_CN
    {
        public CA002_CN()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.CA;
            Config.sClientName = "QA CA Benchmark 002 Create New";
            Config.sPlanName = "QA CA Benchmark 002 Create New Plan";
        ...
        public void test_CA002_CN()
        {
            ...
            dic.Add("ServiceToOpen", "Fund09");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab("Fund09");
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFund09, "Test Cases", "Conversion", true, true);
            ...
            if (Config.bCompareReports)
            {
                ...
                _compareReportsLib._Report(_PassFailStep.Description, "", "Fund09");
