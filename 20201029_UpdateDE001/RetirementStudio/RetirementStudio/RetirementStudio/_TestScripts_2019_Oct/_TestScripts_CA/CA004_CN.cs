...
namespace RetirementStudio._TestScripts_2019_Oct_CA
{
    ...
    public class CA004_CN
    {
        ...
        public CA004_CN()
        {
            ...
            Config.sClientName = "QA CA Benchmark 004 Create New";
            Config.sPlanName = "QA CA Benchmark 004 Create New Plan";
        ...
        public void test_CA004_CN()
        {
            ...
            Thread thrd_Funding_Funding2008_MortalityProj = new Thread(() => new CA004_CN().t_CompareRpt_Funding_Funding2008_MortalityProj(sOutputFunding_Funding2008_MortalityProj));
            ...
            ////////pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Funding2008_Baseline, "Test Cases", "RollForward", true, true);
            ...
            ////////pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Funding2008_UpdateSolvency, "Test Cases", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Funding2008_UpdateSolvency, "Payout Projection", "RollForward", true, true);
