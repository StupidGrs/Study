...
namespace RetirementStudio._TestScripts_2019_Oct_DE
{
    ...
    public class DE009_CN
    {
        ...
        public void test_DE009_CN()
        {
            ...
            _gLib._MsgBox("", "delete Conversion service");
            ...
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Member Statistics", "Conversion", false, true, 0, new string[5] { "HerrDrHille", "HerrLinicus", "HerrProfDrGrebe", "HerrProfDrPiper", "HerrDrRurup" });
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Valuation Summary", "Conversion", false, true, 0, new string[5] { "HerrDrHille", "HerrLinicus", "HerrProfDrGrebe", "HerrProfDrPiper", "HerrDrRurup" });
            dic.Clear();
