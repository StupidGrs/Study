...
namespace RetirementStudio._TestScripts_2019_Oct_DE
{
    ...
    public class DE001_DNT
    {
        ...
        public string sOutputPension_Conversion2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_001\Production\VAL\Conversion 2008\7.5_20200323_B\";
        public string sOutputPension_Pension2009_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_001\Existing DNT\Val\Pension 2009\20190731_QA2_Baseline\";
        ...
        public void test_DE001_DNT()
        {
            ...
            //////////Thread thrd_Conversion2008_WithBreaks_2DCashflow_PP = new Thread(() => new DE001_DNT().t_CompareRpt_Conversion2008_WithBreaks_2DCashflow_PP(sOutputPension_Conversion2008_WithBreaks_2DCashflow_PP));
            ...
            ////////dic.Add("MenuItem_1", "Payout Projection Options");
            ////////dic.Add("MenuItem_2", "2D Cash flow");
            ...
            ////////dic.Add("NumberOfYears", "120");
            ////////dic.Add("MaxNumberOfYears2ndDimension", "35");
            ////////dic.Add("OK", "Click");
            ...
            ////////dic.Add("iSelectColNum", "1");
            ////////dic.Add("MenuItem_1", "Payout Projection Options");
            ////////dic.Add("MenuItem_2", "Payout Projection by Participant");
            ////////pMain._FlowTreeRightSelect(dic);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2008, "Payout Projection by Participant", "Conversion", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2008, "2D Cash flow Projection", "Conversion", true, true);


            _gLib._MsgBox("", "please manually download Member Statistics and Valuation Summary report - Pen1 10 Deck Plan, Pen1 53 Plan Ren, Pen2 54 The Second Plan Ren, Pen2 8 Gesam Plan, Pen3SF 11 Maho Plan, Pen3SF 21 Deferred Plan");
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Pension2009, "Test Cases", "Conversion", true, true);
            ...
            dic.Add("PayoutProjection", "True");
            dic.Add("ApplyWithdrawalAdjustment", "True");
            dic.Add("PayoutProjection_2DCashFlow", "");
            dic.Add("PayoutProjection_PayoutProjectionByParticpant", "");
            dic.Add("IncludeIOE", "");
            dic.Add("GenerateParameterPrint", "True");
            dic.Add("GenerateTestCaseOutput", "True");
            dic.Add("SaveResultsforAuditReport", "True");
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Parameter Summary", "Conversion", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputJubilee_JubileeConversion2008, "Test Cases", "Conversion", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Liability Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Member Statistics", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Conversion Diagnostic", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Test Case List", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Detailed Results", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Detailed Results by Plan Def", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Valuation Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Valuation Summary for Excel Export", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "Individual Output", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJubilee_JubileeConversion2008, "IOE", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputJubilee_JubileeConversion2008, "Payout Projection", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputJubilee_JubileeConversion2008, "Member Statistics", "Conversion", false, true, 0, new string[2] { "LargerGroup", "SmallerGroup"});
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputJubilee_JubileeConversion2008, "Valuation Summary", "Conversion", false, true, 0, new string[2] { "LargerGroup", "SmallerGroup"});
            dic.Clear();
            dic.Add("Group_ReportBreak", "True");
            pOutputManager._ExportReport_Custom_PDF_EXCEL(Config.eCountry, sOutputJubilee_JubileeConversion2008, "Payout Projection", "Conversion", false, true, dic);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputJubilee_Jubilee2009_ChangeTradeAndIAInterest, "Test Cases", "Conversion", true, true);
        ...
        public void t_CompareRpt_Conversion2008(string sOutputPension_Conversion2008)
        {
            ...
            if (Config.bCompareReports)
            {
                ...
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen1_10_Deck Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen1_53_Plan Ren.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen2_54_The Second Plan Ren.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen2_8_Gesam Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen3SF_11_Maho Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("MemberStatistics_Pen3SF_21_Deferred Plan.xlsx", 11, 0, 0, 0);
                ...
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen1_10_Deck Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen1_53_Plan Ren.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen2_54_The Second Plan Ren.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen2_8_Gesam Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen3SF_11_Maho Plan.xlsx", 11, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ValuationSummary_Pen3SF_21_Deferred Plan.xlsx", 11, 0, 0, 0);
