...
{
    /// <summary>
    /// Summary description for UK004_DNT
    /// </summary>
    [CodedUITest]
    public class UK004_DNT
    {
        public UK004_DNT()
        {
        ...
        public string sOutputFunding_ValuationJune2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_004\Production\Funding\Valuation June 2008\7.2_20180314_B\";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_004\Existing\Funding\Valuation June 2008\";
        ...
        public void test_UK004_DNT()
        {
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_ValuationJune2008, "Liability Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_ValuationJune2008, "Member Statistics", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding_ValuationJune2008, "Conversion Diagnostic", "Conversion", false, true, 0);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_ValuationJune2008, "Valuation Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_ValuationJune2008, "Individual Output", "Conversion", false, true);
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("UK004DNT", sOutputFunding_ValuationJune2008_Prod, sOutputFunding_ValuationJune2008);
