...
namespace RetirementStudio._TestScripts_2019_Oct_UK
{
    ...
    public class UK001_CN
    {
        ...
        public string sOutputFunding_UKBM001_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_001\Production\Funding\QA UK BM 001\7.5_20191206_E\";
        ...
        public void test_UK001_CN()
        {
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_UKBM001, "Liability Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_UKBM001, "Member Statistics", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding_UKBM001, "Conversion Diagnostic", "Conversion", false, true, 0);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_UKBM001, "Valuation Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_UKBM001, "Individual Output", "Conversion", false, true);
