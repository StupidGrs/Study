...
{
    /// <summary>
    /// Summary description for UK001_DNT
    /// </summary>
    [CodedUITest]
    public class UK001_DNT
    {
        public UK001_DNT()
        {
        ...
        public string sOutputFunding_QAUKBM001_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_001\Production\Funding\QA UK BM 001\7.2_20180312_B\";
        ...
        public void test_UK001_DNT()
        {
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUKBM001, "Liability Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUKBM001, "Member Statistics", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding_QAUKBM001, "Conversion Diagnostic", "Conversion", false, true, 0);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUKBM001, "Valuation Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUKBM001, "Individual Output", "Conversion", false, true);
