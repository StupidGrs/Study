...
namespace RetirementStudio._TestScripts_2019_Oct_SQL_SP_Load
{
    /// <summary>
    /// Summary description for CodedUITest1
    /// </summary>
    [CodedUITest]
    public class USPreprod_Nutanix
    {
        public USPreprod_Nutanix()
        {
        ...
        static string sCol_RF_Service = "RF_Service";
        static string sCol_Open_Service = "Open_Service";
        static string sCol_RF_Node = "RF_Node";
        static string sCol_Consume_Snapshot = "Consume_Snapshot";
        static string sLogFile = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\US_Timing_Data_2050100\SQL_SP_Test\Timing_RF_ConsumeSnapshot.xlsx";

        #region Timing

        MyTimer mTime_RF_Service = new MyTimer(sCol_RF_Service, sLogFile);
        MyTimer mTime_Open_Service = new MyTimer(sCol_Open_Service, sLogFile);
        MyTimer mTime_RF_Node = new MyTimer(sCol_RF_Node, sLogFile);
        MyTimer mTime_Consume_Snapshot = new MyTimer(sCol_Consume_Snapshot, sLogFile);
        ...
        public void testUS_US_Data_2050100_Derivation()
        {
            ...
            #region RF service, RF node, Consume snapshot

            for (int i = 8; i <= 20; i++)
            {

                string sServiceName = "Testing RF 1.7.2016_" + (i - 1).ToString();
                ...
                dic.Add("Name", sServiceName);
                dic.Add("Parent", "PSS valuation 1.7.2015");
                dic.Add("ParentFinalValuationSet", "VB Contributors");
                ...
                pMain._SelectTab("Home");
                mTime_RF_Service.StopTimer(i);



                mTime_Open_Service.StartTimer();

                dic.Clear();
                dic.Add("PopVerify", "Pop");
                dic.Add("AddServiceInstance", "");
                dic.Add("ServiceToOpen", sServiceName);
                dic.Add("CheckPopup", "False");
                pMain._PopVerify_Home_RightPane(dic);


                pMain._SelectTab(sServiceName);
                mTime_Open_Service.StopTimer(i);


                pMain._SelectTab(sServiceName);
                mTime_RF_Node.StartTimer();
                ...
                dic.Clear();
                dic.Add("PopVerify", "Pop");
                dic.Add("SnapshotName", "2016 PSS - 20160821");
                dic.Add("OK", "");
                ...
                mTime_Consume_Snapshot.StartTimer();
                ...
                mTime_Consume_Snapshot.StopTimer(i);
