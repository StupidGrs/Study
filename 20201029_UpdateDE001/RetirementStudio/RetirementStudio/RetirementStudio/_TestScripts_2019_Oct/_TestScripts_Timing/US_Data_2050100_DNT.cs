...
namespace RetirementStudio._TestScripts_2019_Oct_Timing
{
    ...
    /// </summary>
    [CodedUITest]
    public class US_Data_2050100_DNT
    {
        public US_Data_2050100_DNT()
        {

            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.US;
            //Config.sClientName = "QA Data Test 20K 12092013 D"; //   20K -   US PreProd & Prod

            //Config.sClientName = "QA Data Performance 20K 20160913_F"; //   20K -   US PreProd & Prod
            //Config.sClientName = "QA Data Performance 50K 20160913_F"; //   50K -   US PreProd & Prod
            //Config.sClientName = "QA Data Performance 100k 20160913_F"; //  100K -  US PreProd & Prod



            Config.sClientName = "WB_Data_20K_201705"; //   20K -   CA PreProd & Prod
            //Config.sClientName = "WB_Data_50K_201705"; //   50K -   CA PreProd & Prod
            //Config.sClientName = "WB_Data_100K_201705"; //  100K -  CA PreProd & Prod

            //Config.sClientName = "WB_Data_20K_201706_E"; //   20K -   EU PreProd & Prod
            //Config.sClientName = "WB_Data_50K_201706_E"; //   50K -   EU PreProd & Prod
            //Config.sClientName = "WB_Data_100K_201706_E"; //  100K -  EU PreProd & Prod
            //Config.sClientName = "Data_100K_20140327_B";    // 50K / 100K -   EU PreProd & Prod
            //Config.sClientName = "QA Data Test B 002";    // 20K -   EU PreProd & Prod



            //Config.sClientName = "WB_Data_20K_20160321_F"; //   20K -   QA1
            //Config.sClientName = "Webber_Testing_50K"; //   50K -   QA1
            //Config.sClientName = "Webber_Testing_100K"; //  100K -  QA1
            ...
            //Config.bDownloadReports_EXCEL = false;t
        ...
        static string sData_2012 = "Data2012_20190506";
        ...
        static string sLogFile = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\US_Timing_Data_2050100\Results_UpdatedVersion_CUIT_Phase2.xls";
        static string sOutputDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\US_Timing_Data_2050100\TestOuput\";

        //static string sLogFile = @"C:\Users\webber-ling\Desktop\SQL_Testing\Results_UpdatedVersion_CUIT_Phase2.xls";
        //static string sOutputDir = @"C:\Users\webber-ling\Desktop\SQL_Testing\output\";
        ...
        static string sSimpleImport_DNT = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\Data_PerformanceTest\Data2012_Query_DNT.xls";
        static string sSimpleImport_DNT_FileName = "Data2012_Query_DNT.xls";
        ...
        public void testUS_Data_2050100_DNT()
        {
            ...
            _gLib._MsgBox("Warning!", "Your are going to run Data Timing Test with EE: " + sEENum);
            ...
            #region Undo & Clean Conversion Data Service
            ...
            int iTotalFiles = _gLib._TBL_ReturnTotalNumer_Row("table", pData.wRetirementStudio.wUD_RepositoryContents.tbl_RepositoryContents, 0);

            string sFileName_Act = "";
            Boolean bFile_Exists = false;


            for (int i = 1; i <= iTotalFiles; i++)
            {
                dic.Clear();
                ...
                dic.Add("sCol", "");
                dic.Add("sData", "");
                sFileName_Act = pData._UD_RepositoryContents(dic);


                if (sFileName_Act.Equals(sSimpleImport_DNT_FileName))
                {
                    bFile_Exists = true;
                    break;
                }
            ...
            if (!bFile_Exists)
            {
                ...
                dic.Clear();
                dic.Add("PopVerify", "Pop");
                dic.Add("FileName", sSimpleImport_DNT);
                dic.Add("Open", "Click");
                dic.Add("Cancel", "");
            ...
            mTime.StopTimer(iConversion_RP_Add);
            ...
            pMain._SelectTab("Data2011");
            mTime.StopTimer(iConversion_RP_Generate);
            ...
            dic.Add("Label", "AgeAtTermination");
            dic.Add("DisplayName", "");
            dic.Add("SelectAnExistingWHField", "True");
            dic.Add("ExistingWHField", "AgeAtTermination");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Work Fields");
            dic.Add("Label", "AvgBest3YearsPensionPay");
            dic.Add("DisplayName", "");
            dic.Add("SelectAnExistingWHField", "True");
            dic.Add("ExistingWHField", "AvgBest3YearsPensionPay");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            dic.Add("WarehouseFieldType", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Work Fields");
            dic.Add("Label", "AvgBest5YearsW2Pay");
            dic.Add("DisplayName", "");
            dic.Add("SelectAnExistingWHField", "True");
            dic.Add("ExistingWHField", "AvgBest5YearsW2Pay");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            dic.Add("WarehouseFieldType", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Work Fields");
            dic.Add("Label", "IndexedPension");
            dic.Add("DisplayName", "");
            dic.Add("SelectAnExistingWHField", "True");
            dic.Add("ExistingWHField", "IndexedPension");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            dic.Add("WarehouseFieldType", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Work Fields");
            dic.Add("Label", "AverageBest10YearsPay");
            dic.Add("DisplayName", "");
            dic.Add("SelectAnExistingWHField", "True");
            dic.Add("ExistingWHField", "AverageBest10YearsPay");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            dic.Add("WarehouseFieldType", "");
            ...
            mTime.StopTimer(iRF_IM_MC_ManualMatch_Open);
            ...
            pData._SelectTab("Matching");
            mTime.StopTimer(iRF_IM_MC_ManualMatch_Close);
            ...
            mTime.StopTimer(iRF_CV_Preview);
            ...
            #region RF - Derivations - Run Batch, undo
            ...
            pMain._SelectTab(sData_2012);
            mTime.StopTimer(iRF_DG_RunBatch);
            mLog.LogInfo(iRF_DG_RunBatch, MyPerformanceCounter.Memory_Private);
            ...
            pMain._SelectTab(sData_2012);
            mTime.StopTimer(iRF_DG_Undo);
            mLog.LogInfo(iRF_DG_Undo, MyPerformanceCounter.Memory_Private);
            ...
            pData.pOutputManager._SaveAs(sOutputDir + "PrintAll_Derivations.xlsx");
            ...
            mTime.StopTimer(iRF_DG_PayAverages_PrintAll);
            mLog.LogInfo(iRF_DG_PayAverages_PrintAll, MyPerformanceCounter.Memory_Private);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "W2PAY");
            dic.Add("Level_5", "W2PAYPriorYear11");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "W2PAY");
            dic.Add("Level_5", "W2PAYPriorYear12");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "XPAY");
            dic.Add("Level_5", "XPAYPriorYear22");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "XPAY");
            dic.Add("Level_5", "XPAYPriorYear23");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "XPAY");
            dic.Add("Level_5", "XPAYPriorYear24");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Pay");
            dic.Add("Level_4", "NDPAY");
            dic.Add("Level_5", "NDPAYPriorYear11");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_5", "XHRSPriorYear13");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            dic.Add("Level_3", "Hours");
            dic.Add("Level_4", "XHRS");
            dic.Add("Level_5", "XHRSPriorYear14");
            pData._TreeViewSelect_SelectInputFields_CurrentView(dic, true, false);
            ...
            pMain._SelectTab(sData_2012);
            mTime.StopTimer(iRF_BatchUpdate_SaveToWarehouse);
            mLog.LogInfo(iRF_BatchUpdate_SaveToWarehouse, MyPerformanceCounter.Memory_Private);
            ...
            //////////////////////////////////_gLib._MsgBox("Earnings and Accrued Benefit Checks => Invalid or no pay", "Please Click failed Number <426/105/4445> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Invalid or no pay", "426");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Invalid or no pay", "105");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Invalid or no pay", "4445");
            ...
            //////////////////////////_gLib._MsgBox("Earnings and Accrued Benefit Checks => Accrued benefit change", "Please Click failed Number <1504/5639/12181> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Accrued benefit change", "1504");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Accrued benefit change", "5639");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Earnings and Accrued Benefit Checks => Accrued benefit change", "12181");
            ...
            //////////////////////////_gLib._MsgBox("New Inactive Checks => Invalid or no pension amount, new inactive", "Please Click failed Number <64/271/510> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no pension amount, new inactive", "64");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no pension amount, new inactive", "271");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no pension amount, new inactive", "510");
            ...
            //////////////////////////_gLib._MsgBox("New Inactive Checks => Invalid or no retirement date, in pay inactive", "Please Click failed Number <40/163/299> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no retirement date, in pay inactive", "40");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no retirement date, in pay inactive", "163");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => Invalid or no retirement date, in pay inactive", "299");
            ...
            ////////////////////_gLib._MsgBox("New Inactive Checks => No form of payment, new inactive", "Please Click failed Number <7/3/3> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => No form of payment, new inactive", "7");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => No form of payment, new inactive", "3");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "New Inactive Checks => No form of payment, new inactive", "3");
            ...
            ////////////////////_gLib._MsgBox("Service Checks => Invalid or no Hire Date", "Please Click failed Number <28/0/0> in this Check and click OK to keep testing!");

            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Service Checks => Invalid or no Hire Date", "28");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Service Checks => Invalid or no Hire Date", "0");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail(sData_2012, "Service Checks => Invalid or no Hire Date", "0");
            ...
            pMain._SelectTab(sData_2012);
            mTime.StopTimer(iRF_VU_ActivePayAvgs_CustomFilter_Apply);
            ...
            pData.pOutputManager._SaveAs(sOutputDir + "VU_PrintAll.xlsx");
            ...
            mTime.StopTimer(iRF_VU_ActivePayAvgs_CustomFilter_PrintAll);
            ...
            #region RF - Reports & Simple Import & Checks
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", sSimpleImport_DNT_FileName);
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            pData._PopVerify_IP_SelectFile_FileSelection(dic);
            ...
            pData._ts_SP_CreateExtract(sOutputDir + "SnapshotExtract.xlsx");

            mTime.StopTimer(iRF_SS_Extract);
            mLog.LogInfo(iRF_SS_Extract, MyPerformanceCounter.Memory_Private);
            ...
            if (_gLib._Exists("Yes", pData.wUndo_Popup.wYes.btn, 2, false))
                _gLib._SetSyncUDWin("Yes", pData.wUndo_Popup.wYes.btn, "Click", 0);
            ...
            pMain._SelectTab(sData_2012);
            mTime.StopTimer(iRF_SS_Republish);
            ...
            mTime.StopTimer(iRF_OM_ExportAll);
            mLog.LogInfo(iRF_OM_ExportAll, MyPerformanceCounter.Memory_Private);
            ...
            #region Undo - BatchUpdate, Checks, View&Update, Reports, SimpleImport, Snapshot
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("SnapshotName", "ImportData");
            dic.Add("SnapshotName_Parent", sData_2012);
            dic.Add("OK", "");
            dic.Add("RetainThePreviousUnload", "");
            dic.Add("SpecifyANewSnapshotRetainingPrevious", "");
            dic.Add("SpecifyANewSnapshotRevertingAllFields", "");
            ...
            _gLib._MsgBox("Clean Val Service", "Please delete all valuation sercvices manually!");
