...
namespace RetirementStudio._TestScripts_2019_Oct_Timing
{
    ...
    public class UK_Timing_Regular
    {
        ...
        public void test_UK_Timing_Regular()
        {
            ...
            _excelLog.CloseExcelApplication();
            _t0PercentRunForFSGCashflow_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputDir, "Valuation Summary", "Conversion", false, true);
            ...
            _sER_ReturnRunStatus_ClickRun = null;
            _excelLog.OpenExcelFile("Sheet1");
            _sER_ReturnRunStatus_ClickRun = _excelLog.getOneCellValue(iCNS_ER_ClickRun, iCol_Memory);
            _excelLog.CloseExcelApplication();
            _tCNS_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
            ...
            _sER_ReturnRunStatus_ClickRun = null;
            _excelLog.OpenExcelFile("Sheet1");
            _sER_ReturnRunStatus_ClickRun = _excelLog.getOneCellValue(iTestIndividualOutput_ER_ClickRun, iCol_Memory);
            _excelLog.CloseExcelApplication();
            _tTestIndividualOutput_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
            ...
            _excelLog.CloseExcelApplication();
            _tPPFAndSolvency_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
            ...
            _sER_ReturnRunStatus_ClickRun = null;
            _excelLog.OpenExcelFile("Sheet1");
            _sER_ReturnRunStatus_ClickRun = _excelLog.getOneCellValue(iFixSolvAgeDiff_ER_ClickRun, iCol_Memory);
            _excelLog.CloseExcelApplication();
            _tFixSolvAgeDiff_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
            ...
            _sER_ReturnRunStatus_ClickRun = null;
            _excelLog.OpenExcelFile("Sheet1");
            _sER_ReturnRunStatus_ClickRun = _excelLog.getOneCellValue(iUser2_FixSolvAgeDiff_ER_ClickRun, iCol_Memory);
            _excelLog.CloseExcelApplication();
            _tUser2_FixSolvAgeDiff_ER_ClickRun = Convert.ToDateTime(_sER_ReturnRunStatus_ClickRun);
