...
namespace RetirementStudio._TestScripts_2019_Oct_US
{
    ...
    public class US016_CN
    {
        public US016_CN()
        {
            ...
            Config.sClientName = "QA US Benchmark 016 Create New D";
        ...
        public string sFunding_Val2014_Baseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_016_At_Risk\Production\Val 2014\Baseline\7.5_20191115_Dallas\";
        public string sFunding_Val2014_FinalResults_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_016_At_Risk\Production\Val 2014\Final Results\7.5_20191115_Dallas\";
        ...
        public void test_US016_CN()
        {
            ...
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sFunding_Val2014_Baseline, "Reconciliation to Prior Year", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Detailed Results", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Status Reconciliation", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Member Statistics", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_Baseline, "Individual Checking Template", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Age Service Matrix", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Data Matching Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Combined Status Code Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Gain / Loss Status Reconciliation", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sFunding_Val2014_Baseline, "Gain / Loss Summary of Liability Reconciliation", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sFunding_Val2014_Baseline, "Active Decrement Gain / Loss Detail", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Decrement Age", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_Baseline, "Valuation Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_Baseline, "Individual Output", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_Baseline, "IOE", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_Baseline, "Payout Projection", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_FinalResults, "Funding Calculator Scenario", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sFunding_Val2014_FinalResults, "Liability Scenario", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_FinalResults, "Valuation Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_FinalResults, "Individual Output", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_FinalResults, "IOE", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sFunding_Val2014_FinalResults, "Payout Projection", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sFunding_Val2014_FinalResults, "Reconciliation to Baseline", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_FinalResults, "Liabilities Detailed Results", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Val2014_FinalResults, "ASC 960 Reconciliation", "RollForward", false, true);
