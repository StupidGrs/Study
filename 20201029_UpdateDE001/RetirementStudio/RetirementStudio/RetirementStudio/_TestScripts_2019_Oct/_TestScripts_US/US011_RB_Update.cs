...
namespace RetirementStudio._TestScripts_2019_Oct_US
{
    ...
    /// </summary>
    [CodedUITest]
    public class US011_RB_Update
    {
        public US011_RB_Update()
        {
        ...
        public void test_US011_RB()
        {
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding_val2018_ForAFTAP, "Valuation Summary", "Conversion", true, true);
