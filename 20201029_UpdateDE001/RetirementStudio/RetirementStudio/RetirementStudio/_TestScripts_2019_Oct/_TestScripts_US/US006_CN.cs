...
namespace RetirementStudio._TestScripts_2019_Oct_US
{
    ...
    public class US006_CN
    {
        ...
        public US006_CN()
        {
            ...
            Config.sClientName = "QA US Benchmark 006 Create New D";
        ...
        public void test_US006_CN()
        {
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FolderName", "Interest1");//Interest
            dic.Add("EAN", "");
            dic.Add("FAS35PVAB", "");
            dic.Add("FAS35PVVB", "");
            ...
            dic.Add("Level_1", "Assumptions");
            dic.Add("Level_2", "Interest Rate");
            dic.Add("Level_3", "Interest1"); // Interest
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJanuary2007Valuation, "Liability Summary", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputJanuary2007Valuation, "Liability Summary", "Conversion", false, true, 0);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJanuary2007Valuation, "Member Statistics", "Conversion", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputJanuary2007Valuation, "Conversion Diagnostic", "Conversion", false, true, 0);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJanuary2007Valuation, "Test Case List", "Conversion", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJanuary2007Valuation, "Detailed Results", "Conversion", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputJanuary2007Valuation, "Valuation Summary", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJanuary2007Valuation, "Individual Output", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJanuary2007Valuation, "IOE", "Conversion", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputJanuary2007Valuation, "Payout Projection", "Conversion", false, true);
