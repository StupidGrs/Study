...
namespace RetirementStudio._TestScripts_2019_Oct_Data
{
    ...
    public class CA005
    {
        ...
        public void test_CA005()
        {
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2011, "Valuation Summary", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2011, "Valuation Summary", "Conversion", false, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutput_Data2011, "IOE", "Conversion", false, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutput_Data2011, "Parameter Print", "Conversion", true, false);
            ...
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Active Decrement Gain / Loss Detail", "RollForward", true, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Gain / Loss Summary of Liability Reconciliation", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Valuation Summary", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Parameter Print", "RollForward", true, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Active Decrement Gain / Loss Detail", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Gain / Loss Summary of Liability Reconciliation", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Valuation Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "Individual Output", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutput_Data2014, "IOE", "RollForward", false, true);
