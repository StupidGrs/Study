...
namespace RetirementStudio._TestScripts_2019_Oct_Data
{
    ...
    public class US018
    {
        ...
        public US018()
        {
            ...
            Config.sClientName = "QA US Benchmark 018 Create New_20190408";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                else
                {
                    ...
                    sWriteFile_2012 = sMainDir + sPostFix + "\\2012\\Data2012_Query.xls";
                    sWriteFile_2013 = sMainDir + sPostFix + "\\2013\\Data2013_Query.xls";
            ...
            sContent = sContent + "sWriteFile_2012 = @\"" + sOutput_Data2012 + "Data2012_Query.xls\";" + Environment.NewLine;
            sContent = sContent + "sWriteFile_2013 = @\"" + sOutput_Data2013 + "Data2013_Query.xls\";" + Environment.NewLine;
        ...
        public void test_US018()
        {
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2012, "Valuation Summary", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2012, "Valuation Summary", "Conversion", false, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutput_Data2012, "IOE", "Conversion", false, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutput_Data2012, "Parameter Print", "Conversion", true, false);
            ...
            sWriteFile_2013 = sOutput_Data2013 + "Data2013_Query.xls";
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "Data2013_Query.xls");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            pData._PopVerify_IP_SelectFile_FileSelection(dic);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2013, "Valuation Summary", "RollForward", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutput_Data2013, "Valuation Summary", "RollForward", false, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutput_Data2013, "IOE", "RollForward", false, false);
