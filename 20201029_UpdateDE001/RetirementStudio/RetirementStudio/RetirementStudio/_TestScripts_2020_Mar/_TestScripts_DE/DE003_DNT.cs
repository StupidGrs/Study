...
namespace RetirementStudio._TestScripts_2020_Mar_DE
{
    ...
    public class DE003_DNT
    {
        ...
        public void test_DE003_DNT()
        {
            ...
            Thread Thrd_Pension2009_Baseline = new Thread(() => new DE003_DNT().t_CompareRpt_Pension2009_Baseline(sOutputPension_Pension2009_Baseline));
        ...
        public void t_CompareRpt_Pension2009_Baseline(string sOutputPension_Pension2009_Baseline)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_Baseline_Prod, sOutputPension_Pension2009_Baseline);
