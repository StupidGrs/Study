...
{
    /// <summary>
    /// Summary description for DE007_DNT
    /// </summary>
    [CodedUITest]
    public class DE007_DNT
    {
        public DE007_DNT()
        {
        ...
        public string sOutputPension_Conversion2010_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_007\Production\7.5_20191111_B\Conversion2010\";
        public string sOutputPension_Stichtag2011_Teriferhoehung_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_007\Production\7.5_20191111_B\Stichtag2011_Teriferhoehung\";
        public string sOutputPension_Stichtag2011_IFRSneueAnnahmen_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_007\Production\7.5_20191111_B\Stichtag2011_IFRSneueAnnahmen\";
        ...
        public void test_DE007_DNT()
        {


            #region MultiThreads

            Thread thrd_Conversion2010 = new Thread(() => new DE007_DNT().t_CompareRpt_Conversion2010(sOutputPension_Conversion2010));
            Thread thrd_Stichtag2011_Teriferhoehung = new Thread(() => new DE007_DNT().t_CompareRpt_Stichtag2011_Teriferhoehung(sOutputPension_Stichtag2011_Teriferhoehung));
            ...
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Member Statistics", "Conversion", false, true, 0, new string[1] { "DriectPromise" });
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Valuation Summary", "Conversion", false, true, 0, new string[1] { "DriectPromise" });
            dic.Clear();
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE007DNT", sOutputPension_Stichtag2011_IFRSneueAnnahmen_Prod, sOutputPension_Stichtag2011_IFRSneueAnnahmen);
        ...
        public void t_CompareRpt_Conversion2010(string sOutputPension_Conversion2010)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE007DNT", sOutputPension_Conversion2010_Prod, sOutputPension_Conversion2010);
        ...
        public void t_CompareRpt_Stichtag2011_Teriferhoehung(string sOutputPension_Stichtag2011_Teriferhoehung)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE007DNT", sOutputPension_Stichtag2011_Teriferhoehung_Prod, sOutputPension_Stichtag2011_Teriferhoehung);
