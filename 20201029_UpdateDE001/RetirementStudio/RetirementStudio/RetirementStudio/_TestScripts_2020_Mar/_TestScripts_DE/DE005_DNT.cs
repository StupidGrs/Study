...
{
    /// <summary>
    /// Summary description for DE005_DNT
    /// </summary>
    [CodedUITest]
    public class DE005_DNT
    {
        public DE005_DNT()
        {
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_005\Existing\Val\";
        ...
        public void test_DE005_DNT()
        {


            #region MultiThreads

            Thread thrd_Conversion2009 = new Thread(() => new DE005_DNT().t_CompareRpt_Conversion2009(sOutputPension_Conversion2009));
            ...
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2009, "Member Statistics", "Conversion", false, true, 0, new string[1] { "DriectPromise" });
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2009, "Valuation Summary", "Conversion", false, true, 0, new string[1] { "DriectPromise" });
            dic.Clear();
            ...
            #region sOutputPension_Stichtag2010
            ...
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Reconciliation to Prior Year", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Detailed Results", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Member Statistics", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Status Reconciliation", "RollForward", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Individual Checking Template", "RollForward", false, true, 0, new string[1] { "Flex" });
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Valuation Summary for Excel Export", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Individual Output", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "IOE", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Payout Projection", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "FAS Expected Benefit Pmts", "RollForward", false, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Member Statistics", "RollForward", false, true, 0, new string[1] { "DirectPromise" });
            ...
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "FAS Expected Benefit Pmts", "RollForward", false, true, 0, new string[1] { "ALL" });
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Liability Set for Globe Export", "RollForward", false, true, 0, new string[1] { "ALL" });
            dic.Clear();
            dic.Add("Group_ReportBreak", "True");
            pOutputManager._ExportReport_Custom_PDF_EXCEL(Config.eCountry, sOutputPension_Stichtag2010, "Payout Projection", "RollForward", false, true, dic);



            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE005DNT", sOutputPension_Stichtag2010_Prod, sOutputPension_Stichtag2010);
        ...
        public void t_CompareRpt_Conversion2009(string sOutputPension_Conversion2009)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE005DNT", sOutputPension_Conversion2009_Prod, sOutputPension_Conversion2009);
