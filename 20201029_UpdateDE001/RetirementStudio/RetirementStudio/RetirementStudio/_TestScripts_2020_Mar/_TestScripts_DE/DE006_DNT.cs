...
namespace RetirementStudio._TestScripts_2020_Mar_DE
{
    ...
    public class DE006_DNT
    {
        ...
        public void test_DE006_DNT()
        {
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputPension_Pensionen2011_Baseline, "Parameter Summary", "RollForward", true, true);
        ...
        public void t_CompareRpt_Pensionen2011_Baseline(string sOutputPension_Pensionen2011_Baseline)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE006DNT", sOutputPension_Pensionen2011_Baseline_Prod, sOutputPension_Pensionen2011_Baseline);
