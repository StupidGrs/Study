...
namespace RetirementStudio._TestScripts_2020_Mar_Others
{
    ...
    public class US019_DNT
    {
        ...
        public void test_US019_DNT()
        {
            ...
            Thread thrd_Funding2018_OptOutPrescribedMort = new Thread(() => new US019_DNT().t_CompareRpt_Funding2018_OptOutPrescribedMort(sFunding2018_OptOutPrescribedMort));
        ...
        void t_CompareRpt_Funding2018_OptOutPrescribedMort(string sFunding2018_OptOutPrescribedMort)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US019DNT", sFunding2018_OptOutPrescribedMort_Prod, sFunding2018_OptOutPrescribedMort);
