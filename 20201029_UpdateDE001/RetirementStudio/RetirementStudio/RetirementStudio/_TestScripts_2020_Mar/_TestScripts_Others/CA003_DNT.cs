...
namespace RetirementStudio._TestScripts_2020_Mar_Others
{
    ...
    public class CA003_DNT
    {
        ...
        public void test_CA003_DNT()
        {
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding_Valuation2008, "Test Cases", "Conversion", true, true);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting_Valuation2008, "Test Cases", "Conversion", true, false);
