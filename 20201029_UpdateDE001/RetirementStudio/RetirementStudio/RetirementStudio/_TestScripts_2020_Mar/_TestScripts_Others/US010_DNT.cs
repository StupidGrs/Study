...
{
    /// <summary>
    /// Summary description for US010_DNT
    /// </summary>
    [CodedUITest]
    public class US010_DNT
    {
        ...
        public string sOutputFunding_July2006Valuation_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Production\July 2006 Valuation\000_7.5_Baseline\";
        public string sOutputFunding_July2007Valuation_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Production\July 2007 Valuation\000_7.5_Baseline\";
        public string sOutputAccounting_July2006FASVal_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Production\July 2006 FAS Val\000_7.5_Baseline\";
        public string sOutputAccounting_July2007FASVal_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Production\July 2007 FAS Val\000_7.5_Baseline\";
        ...
        public void test_US010_DNT()
        {

            sOutputFunding_July2006Valuation = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Existing\July 2006 Valuation\20200303_QA1\";
            sOutputFunding_July2007Valuation = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Existing\July 2007 Valuation\20200303_QA1\";
            sOutputAccounting_July2006FASVal = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Existing\July 2006 FAS Val\20200303_QA1\";
            sOutputAccounting_July2007FASVal = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_010_Drummond\Existing\July 2007 FAS Val\20200303_QA1\";
            ...
            Thread thrd_Funding_July2006Valuation = new Thread(() => new US010_DNT().t_CompareRpt_Funding_July2006Valuation(sOutputFunding_July2006Valuation));
            ...
            Thread thrd_Accounting_July2006FASVal = new Thread(() => new US010_DNT().t_CompareRpt_Accounting_July2006FASVal(sOutputAccounting_July2006FASVal));
            ...
            //pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting_July2007FASVal, "Gain / Loss Status Reconciliation", "RollForward", false, false);
            //pOutputManager._ExportReport_SubReports_PDF_EXCEL(sOutputAccounting_July2007FASVal, "Gain / Loss Summary of Liability Reconciliation", "RollForward", false, false);
            //pOutputManager._ExportReport_SubReports_PDF_EXCEL(sOutputAccounting_July2007FASVal, "Active Decrement Gain / Loss Detail", "RollForward", false, false);
            //pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting_July2007FASVal, "Decrement Age", "RollForward", false, false);
        ...
        void t_CompareRpt_Funding_July2006Valuation(string sOutputFunding_July2006Valuation)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US010DNT", sOutputFunding_July2006Valuation_Prod, sOutputFunding_July2006Valuation);
                _compareReportsLib._Report(_PassFailStep.Description, "", "sOutputFunding");
        ...
        void t_CompareRpt_Accounting_July2006FASVal(string sOutputAccounting_July2006FASVal)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US010DNT", sOutputAccounting_July2006FASVal_Prod, sOutputAccounting_July2006FASVal);
