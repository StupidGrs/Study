...
namespace RetirementStudio._TestScripts_2019_cloud._TestScripts_Timing
{
    ...
    /// </summary>
    [CodedUITest]
    public class UK_Timing_Custom_update
    {
        public UK_Timing_Custom_update()
        {
        ...
        static string sLogFile = @"C:\Users\lin-li3\Desktop\UK_Timing_Test_Custom_CUIT.xls";
        ...
        static string sOutputDir = @"C:\Lin-Li\Projects\New folder\output\";
        ...
        public class DateTimeFormatbyCountry
        {
            public string changeDateTimeFormatbyCountry(string datetime, _Country eCountry)
            {
                ...
                else if (eCountry == _Country.UK)
                {
                    ...
                    string dd = datetime.Substring(3, 2);
                    datetime = datetime.Remove(0, 5);
                    datetime = datetime.Insert(0, dd + "/" + mm);
                    return datetime;
                }
        ...
        public void test_UK_Timing_Custom()
        {
            ...
            int _t25Overall = (_t25ClickRun_GroupJobStatus.Hours * 3600 + _t25ClickRun_GroupJobStatus.Minutes * 60 + _t25ClickRun_GroupJobStatus.Seconds) - (_t25JobSent_Persist.Hours * 3600 + _t25JobSent_Persist.Minutes * 60 + _t25JobSent_Persist.Seconds);
            ...
            int _tCMI15Overall = (_tCMI15ClickRun_GroupJobStatus.Hours * 3600 + _tCMI15ClickRun_GroupJobStatus.Minutes * 60 + _tCMI15ClickRun_GroupJobStatus.Seconds) - (_tCMI15JobSent_Persist.Hours * 3600 + _tCMI15JobSent_Persist.Minutes * 60 + _tCMI15JobSent_Persist.Seconds);
            ...
            int _t1Overall = (_t1ClickRun_GroupJobStatus.Hours * 3600 + _t1ClickRun_GroupJobStatus.Minutes * 60 + _t1ClickRun_GroupJobStatus.Seconds) - (_t1JobSent_Persist.Hours * 3600 + _t1JobSent_Persist.Minutes * 60 + _t1JobSent_Persist.Seconds);
            ...
            string _sPPFAndSolvency_60JobSuccess = pMain._ER_ReturnRunStatus_BottomGrid("Job Status Info", 2, 12);
