...
namespace RetirementStudio._TestScripts_2019_cloud._TestScripts_US
{
    ...
    /// </summary>
    [CodedUITest]
    public class US007_Cloud
    {
        public US007_Cloud()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.US;
            Config.sClientName = "QA US Benchmark 007 Cloud";
            Config.sPlanName = "QA US Benchmark 007 Cloud Plan";
        ...
        public string sOutputFunding2005_Cloud = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\Funding 2005\000_7.5_Baseline\";
        public string sOutputFunding2006_Cloud = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\Funding 2006\000_7.5_Baseline\";
        public string sOutputAccounting2005_Cloud = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\2005 Accounting\000_7.5_Baseline\";
        public string sOutputAccounting2006_Cloud = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\2006 Accounting\000_7.5_Baseline\";
        ...
        public void test_US007_Cloud()
        {

            #region MultiThreads
            
            Thread thrd_Funding2005 = new Thread(() => new US007_Cloud().t_CompareRpt_Funding2005(sOutputFunding2005));
            Thread thrd_Funding2006 = new Thread(() => new US007_Cloud().t_CompareRpt_Funding2006(sOutputFunding2006));
            Thread thrd_Accounting2005 = new Thread(() => new US007_Cloud().t_CompareRpt_Accounting2005(sOutputAccounting2005));
            ...
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "Liability Summary", "Conversion", true, true);
            //////////pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding2005, "Liability Summary", "Conversion", true, true, 0);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding2005, "Member Statistics", "Conversion", true, true);
            //////////pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding2005, "Conversion Diagnostic", "Conversion", true, true, 0);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding2005, "Test Case List", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding2005, "Detailed Results", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding2005, "Detailed Results by Plan Def", "Conversion", false, true);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputFunding2005, "Valuation Summary", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "Individual Output", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "IOE", "Conversion", false, true);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "Parameter Print", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "Test Cases", "Conversion", true, true);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2005, "Payout Projection", "Conversion", true, true);
            ...
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputFunding2006, "Age Service Matrix", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2006, "Liability Set for FSM Export", "RollForward", true, false);
            ...
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Liability Summary", "Conversion", true, false);
            //////////pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputAccounting2005, "Liability Summary", "Conversion", true, false, 0);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "Member Statistics", "Conversion", true, false);
            //////////pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputAccounting2005, "Conversion Diagnostic", "Conversion", true, false, 0);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Conversion Diagnostic", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "Test Case List", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "Detailed Results", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "Detailed Results by Plan Def", "Conversion", false, false);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "Valuation Summary", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Individual Output", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "IOE", "Conversion", false, false);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Parameter Print", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Test Cases", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2005, "Payout Projection", "Conversion", true, false);
            //////////pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputAccounting2005, "FAS Expected Benefit Pmts", "Conversion", true, false);
            ...
            //////////pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputAccounting2006, "Age Service Matrix", "RollForward", true, false);
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US007Cloud", sOutputAccounting2006_Cloud, sOutputAccounting2006);
        ...
        void t_CompareRpt_Funding2005(string sOutputFunding2005)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US007Cloud", sOutputFunding2005_Cloud, sOutputFunding2005);
        ...
        void t_CompareRpt_Funding2006(string sOutputFunding2006)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US007Cloud", sOutputFunding2006_Cloud, sOutputFunding2006);
        ...
        void t_CompareRpt_Accounting2005(string sOutputAccounting2005)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US007Cloud", sOutputAccounting2005_Cloud, sOutputAccounting2005);
