...
namespace RetirementStudio._TestScripts_2019_cloud._TestScripts_US
{
    ...
    /// </summary>
    [CodedUITest]
    public class US014_Cloud
    {
        public US014_Cloud()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.US;
            Config.sClientName = "QA US Benchmark 014 Cloud";
            Config.sPlanName = "QA US Benchmark 014 Cloud Plan";
        ...
        public string sOutputBaseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_014_EAN\Existing\20191117_QA1\";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                else
                {
                    ...
                    string sPostFix = _gLib._ReturnDateStampYYYYMMDD() + "_QA1_Cloud";
        ...
        public void test_US014_Cloud()
        {
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("US014Cloud", sOutputBaseline_Prod, sOutputBaseline);
