...
namespace RetirementStudio._TestScripts._TestScripts_US
{
    ...
    /// </summary>
    [CodedUITest]
    public class US009_RB
    {
        public US009_RB()
        {
            Config.eEnv = _TestingEnv.Prod_US;
            Config.eCountry = _Country.US;
            Config.sClientName = "QA US Benchmark 009";
            Config.sPlanName = "QA US Benchmark 009 Plan";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_009_Saks\Production\";
        ...
        public void test_US009_RB()
        {
            ...
            #region 2005 Funding - Rebaseline reports
            ...
            #region 2006 Funding - Rebaseline reports
            ...
            #region Accounting 2005 - Rebaseline reports
            ...
            #region Accounting 2006 - Rebaseline reports
