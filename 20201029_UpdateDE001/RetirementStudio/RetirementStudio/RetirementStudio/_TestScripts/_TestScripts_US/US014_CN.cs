...
namespace RetirementStudio._TestScripts._TestScripts_US
{
    ...
    public class US014_CN
    {
        ...
        public void test_US014_CN()
        {
            ...
            dic.Add("ClientCode", "EAN");
            dic.Add("FiscalYearEnd", "09/30");
            dic.Add("MeasurementDate", "09/30");
            dic.Add("Notes", "Client Owner: Karen Lanctot. Original client: Entry Age Normal Benchmark Client");
            ...
            dic.Add("EffectiveDate", "10/01/2009");
            dic.Add("Parent", "");
            dic.Add("RSC", "True");
            dic.Add("Shared", "");
            dic.Add("GeneralUse", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\US014\Conversion2009.xlsx");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileDefinitionName", "Data2009");
            dic.Add("FileType", "");
            dic.Add("Browse", "Click");
            dic.Add("Preview", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "Conversion2009.xlsx");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Verify");
            dic.Add("Unique_NoMatch_Num", "450");
            ...
            for (int iAge = 55; iAge <= 59; iAge++)
                ...
                sTable_RetRates = sTable_RetRates + "0.050000" + Environment.NewLine;


            sTable_RetRates = sTable_RetRates + "0.100000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.100000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.500000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.150000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.150000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.750000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.150000" + Environment.NewLine;
            sTable_RetRates = sTable_RetRates + "0.150000" + Environment.NewLine;
