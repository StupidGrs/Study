...
{
    /// <summary>
    /// Summary description for US006_RB
    /// </summary>
    [CodedUITest]
    public class US006_RB
    {
        public US006_RB()
        {
            ...
            //Config.sClientName = "QA US Benchmark 006";
            //Config.sPlanName = "QA US Benchmark 006 Plan";
            Config.sClientName = "QA US Benchmark 006 D";
            Config.sPlanName = "QA US Benchmark 006 D Plan";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            {
                string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_006_Morgan_Stanley_EEP\Production\";
                string sPostFix = Config.sProductionVerison + "_" + _gLib._ReturnDateStampYYYYMMDD();

                sPostFix = sPostFix + "_Dallas";

                _gLib._MsgBoxYesNo("Are you sure to create folders under below directory ?", sMainDir);
                sOutputBaseline = _gLib._CreateDirectory(sMainDir + "January 2007 Valuation\\" + sPostFix + "\\");
            }
