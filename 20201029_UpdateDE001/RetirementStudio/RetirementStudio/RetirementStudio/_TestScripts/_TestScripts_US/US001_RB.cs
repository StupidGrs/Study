...
{
    /// <summary>
    /// Summary description for US001_RB
    /// </summary>
    [CodedUITest]
    public class US001_RB
    {
        public US001_RB()
        {
            ...
            //Config.sClientName = "QA US Benchmark 001";
            //Config.sPlanName = "QA US Benchmark 001";
            Config.sClientName = "QA US Benchmark 001 D";
            Config.sPlanName = "QA US Benchmark 001 D";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            {
                string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_001_Saks_PIA_1_ReduceBen\Production\PIA_1\";
                ...
                sOutputBaseline = _gLib._CreateDirectory(sMainDir + sPostFix + "\\Baseline\\");
                sOutputUS003 = _gLib._CreateDirectory(sMainDir + sPostFix + "\\US003\\");
                sOutputUS004 = _gLib._CreateDirectory(sMainDir + sPostFix + "\\US004\\");
                sOutputUS002 = _gLib._CreateDirectory(sMainDir + sPostFix + "\\US002\\");
