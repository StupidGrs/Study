...
namespace RetirementStudio._TestScripts._TestScripts_UK
{
    ...
    public class UK005_CN
    {
        ...
        public string sOutputFunding_QAUKBenchmark005_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_005\Production\Funding\7.2_20180315_B\";

        String sTable_ER60TO65 = "";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            else
            {
                ...
                string sMainDir = sDir + "UK005_" + _gLib._ReturnDateStampYYYYMMDD();

                //////_gLib._MsgBoxYesNo("Are you sure to create folders under below directory ?", sMainDir);

                _gLib._CreateDirectory(sMainDir);
                sOutputFunding_QAUKBenchmark005 = _gLib._CreateDirectory(sMainDir + "\\sOutputFunding_QAUKBenchmark005\\");
        ...
        public void test_UK005_CN()
        {
            ...
            dic.Add("ClientCode", "WIGAN");
            dic.Add("FiscalYearEnd", "04/30");
            dic.Add("MeasurementDate", "04/30");
            dic.Add("Notes", "UK_Test_Wigan"
                + Environment.NewLine + "Client Owner:  James Magee"
            ...
            _gLib._MsgBox("Mannual Steps", "click Plan name <QA UK Benchmark 005 Create New Plan> in left Tree");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "QA_UK_Data_005");
            dic.Add("EffectiveDate", "30/04/2008");
            dic.Add("Parent", "");
            dic.Add("RSC", "");
            dic.Add("Shared", "");
            dic.Add("GeneralUse", "");
            ...
            dic.Add("ServiceToOpen", "QA_UK_Data_005");
            pMain._PopVerify_Home_RightPane(dic);

            pMain._Home_ToolbarClick_Top(true);


            pMain._SelectTab("QA_UK_Data_005");


            dic.Clear();
            dic.Add("Level_1", "QA_UK_Data_005");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\UK005\QA_UK_Data_005.xls");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileDefinitionName", "UK 005  Benchmark");
            dic.Add("FileType", "");
            dic.Add("Browse", "Click");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "QA_UK_Data_005.xls");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            ...
            pData._IP_Mapping_Initialize("Personal Information", "Custom Fields", 1, 0, 1, "EQPEN");
            ...
            pData._IP_Mapping_Initialize("Personal Information", "Pay", 2, 10, 1, "FinalPay");
            pData._IP_Mapping_Initialize("Personal Information", "FinalPay", 3, 10, 1, "FinalPayCurrentYear");
            pData._IP_Mapping_Initialize("Personal Information", "Pay1", 3, 10, 1, "Pay1CurrentYear");


            pData._IP_Mapping_MapField("FinalPayCurrentYear", "FinalPayCurrentYear", 10, false);
            pData._IP_Mapping_MapField("Pay1CurrentYear", "PayCurrentYear", 0, true);
            pData._IP_Mapping_MapField("BPRE88", "BPRE88", 0, true);

            pData._IP_Mapping_MapField("BPST88NE", "BPST88NE", 0, true);
            pData._IP_Mapping_MapField("AccrualRate", "AccrualRate", 20, true);
            pData._IP_Mapping_MapField("TINGMP", "TINGMP", 0, true);

            pData._IP_Mapping_MapField("DALSERV", "DALSERV", 0, true);
            pData._IP_Mapping_MapField("EADDPEN", "EADDPEN", 0, true);
            pData._IP_Mapping_MapField("BARBFRAC", "BARBFRAC", 0, true);

            pData._IP_Mapping_MapField("PUP", "PUP", 0, true);
            pData._IP_Mapping_MapField("RETAGE", "RETAGE", 0, true);
            pData._IP_Mapping_MapField("CAT1", "CAT1", 0, true);

            pData._IP_Mapping_MapField("CAT2", "CAT2", 0, true);
            pData._IP_Mapping_MapField("CAT3", "CAT3", 0, true);
            pData._IP_Mapping_MapField("PRE97IND", "PRE97IND", 0, true);

            pData._IP_Mapping_MapField("CAT4", "CAT4", 0, true);
            pData._IP_Mapping_MapField("EQPEN", "EQPEN", 0, true);
            ...
            dic.Add("Unique_NoMatch_Num", "375");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("DerivationGroupName", "AllMembers");
            dic.Add("Filter", "");
            dic.Add("MoveUp", "");
            dic.Add("MoveDown", "");
            dic.Add("Add", "Click");
            ...
            for (int i = 1; i <= 59; i++)
                sTable_ER60TO65 = sTable_ER60TO65 + "0.000000" + Environment.NewLine;

            for (int i = 60; i <= 64; i++)
                sTable_ER60TO65 = sTable_ER60TO65 + "0.200000" + Environment.NewLine;

            sTable_ER60TO65 = sTable_ER60TO65 + "1.000000" + Environment.NewLine;

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "ER60TO65");
            ...
            dic.Add("OK", "Click");
            dic.Add("sUnisexRates", sTable_ER60TO65);
            dic.Add("sMaleRates", "");
            ...
            pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Valuation Summary", "Conversion", true, true);
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Parameter Print", "Conversion", true, true);
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Test Cases", "Conversion", true, true);

            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Liability Summary", "Conversion", true, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Member Statistics", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_QAUKBenchmark005, "Conversion Diagnostic", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Valuation Summary", "Conversion", true, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Individual Output", "Conversion", true, true);
            }


            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Liability Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Member Statistics", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_QAUKBenchmark005, "Conversion Diagnostic", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Detailed Results", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Detailed Results with Ben Type splits", "Conversion", false, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Valuation Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Individual Output", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "IOE", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Payout Projection - Benefit Cashflows", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_QAUKBenchmark005, "Payout Projection - Other Info", "Conversion", false, true);
