...
{
    /// <summary>
    /// Summary description for UK001_CN
    /// </summary>
    [CodedUITest]
    public class UK001_CN
    {
        public UK001_CN()
        {
            ...
            Config.sClientName = "QA UK Benchmark 001 Create New";
            Config.sPlanName = "QA UK Benchmark 001 Create New Plan";
        ...
        public string sOutputFunding_UKBM001_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_001\Production\Funding\QA UK BM 001\6.9.1_20160925_B\";
        ...
        public void test_UK001_CN()
        {
            
            this.GenerateReportOuputDir();

            #region Create client and add BenefitSet
            ...
            dic.Add("ClientCode", "QAUK001");
            dic.Add("FiscalYearEnd", "07/01");
            dic.Add("MeasurementDate", "07/01");
            dic.Add("Notes", "UK - Test Arsenal / UpdatedwithSpouses data snapshot" + Environment.NewLine + "Client Owner:  Marc Knowles" + Environment.NewLine + "Date Created:" + _gLib._ReturnDateStampYYYYMMDD());
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "Data - QA UK BM 001");
            dic.Add("EffectiveDate", "01/07/2008");
            dic.Add("Parent", "");
            dic.Add("RSC", "");
            dic.Add("Shared", "");
            dic.Add("GeneralUse", "");
            ...
            dic.Add("ServiceToOpen", "Data - QA UK BM 001");
            pMain._PopVerify_Home_RightPane(dic);

            dic.Clear();
            dic.Add("Level_1", "Data - QA UK BM 001");
            ...
            dic.Add("Label", "AccruedSpousePension");
            dic.Add("DisplayName", "");
            ...
            dic.Add("Label", "Ben1Ben1_Pre88GMP");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Custom Fields");
            dic.Add("Label", "Ben1Ben1_Pst88GMP");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Custom Fields");
            dic.Add("Label", "Benefit1DBPre88GMP");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Custom Fields");
            dic.Add("Label", "Benefit1DBPst88GMP");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Custom Fields");
            dic.Add("Label", "ECASH_SacleCommCash");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Category", "Custom Fields");
            dic.Add("Label", "AccruedBenefitSpouse");
            dic.Add("DisplayName", "");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\UK001\UpdatedwithSpouses.xls");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileDefinitionName", "UpdatedwithSpouses");
            dic.Add("FileType", "");
            dic.Add("Browse", "Click");
            dic.Add("Preview", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "UpdatedwithSpouses.xls");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            ...
            pData._IP_Mapping_Initialize("Personal Information", "Custom Fields", 1, 0, 1, "Ben1Ben1_Pre88GMP");

            pData._IP_Mapping_MapField("Ben1Ben1_Pre88GMP", "Ben1Ben1_Pre88GMP", 3, false);
            pData._IP_Mapping_MapField("Ben1Ben1_Pst88GMP", "Ben1Ben1_Pst88GMP", 5, true);
            pData._IP_Mapping_MapField("Benefit1DBPre88GMP", "Benefit1DB_Pre88GMP", 15, true);
            pData._IP_Mapping_MapField("Benefit1DBPst88GMP", "Benefit1DB_Pst88GMP", 17, true);
            pData._IP_Mapping_MapField("GUAR", "GUAR", 9, true);
            pData._IP_Mapping_MapField("GREVRATE", "GREVRATE", 7, true);
            pData._IP_Mapping_MapField("GREVTYPE", "GREVTYPE", 8, true);
            pData._IP_Mapping_MapField("PPENAVC", "PPENAVC", 6, true);
            pData._IP_Mapping_MapField("PAVCINC", "PAVCINC", 2, true);
            pData._IP_Mapping_MapField("NRD_RetDate", "NRD_RetDate", 2, true);
            pData._IP_Mapping_MapField("ECASH_SacleCommCash", "ECASH_SacleCommCash", 0, true);
            pData._IP_Mapping_MapField("EEID2", "EEID2", 4, true);
            pData._IP_Mapping_MapField("EEID3", "EEID3", 5, true);
            pData._IP_Mapping_MapField("AccruedBenefitSpouse", "AccruedBenefitSpouse", 8, true);
...
dic.Clear();
            ...
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Parameter Print", "Conversion", true, true);
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Test Cases", "Conversion", true, true);

            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Liability Summary", "Conversion", true, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_UKBM001, "Member Statistics", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_UKBM001, "Conversion Diagnostic", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_UKBM001, "Valuation Summary", "Conversion", true, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Individual Output", "Conversion", true, true);
            }


            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Liability Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_UKBM001, "Member Statistics", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_UKBM001, "Conversion Diagnostic", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_UKBM001, "Detailed Results", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Detailed Results with Ben Type splits", "Conversion", false, true);
                pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_UKBM001, "Valuation Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Individual Output", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "IOE", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Payout Projection - Benefit Cashflows", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_UKBM001, "Payout Projection - Other Info", "Conversion", false, true);
