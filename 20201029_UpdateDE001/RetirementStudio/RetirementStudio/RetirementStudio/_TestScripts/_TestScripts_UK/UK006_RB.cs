...
{
    /// <summary>
    /// Summary description for UK006_RB
    /// </summary>
    [CodedUITest]
    public class UK006_RB
    {
        public UK006_RB()
        {
            Config.eEnv = _TestingEnv.Prod_EU;
            Config.eCountry = _Country.UK;
            Config.sClientName = "QA UK Benchmark 006";
            Config.sPlanName = "QA UK Benchmark 006 Plan";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            {
                string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_006\Production\";
