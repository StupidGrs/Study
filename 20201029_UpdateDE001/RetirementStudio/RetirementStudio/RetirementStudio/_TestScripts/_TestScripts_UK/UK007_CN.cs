...
namespace RetirementStudio._TestScripts._TestScripts_UK
{
    ...
    public class UK007_CN
    {
        ...
        public void test_UK007_CN()
        {
            ...
            MyExcel _excel = new MyExcel(@"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\UK007\CurrentViewLables.xlsx", true);
