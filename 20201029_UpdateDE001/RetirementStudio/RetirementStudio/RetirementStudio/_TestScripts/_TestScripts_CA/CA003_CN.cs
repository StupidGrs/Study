...
{
    /// <summary>
    /// Summary description for CA003_CN
    /// </summary>
    [CodedUITest]
    public class CA003_CN
    {
        public CA003_CN()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.CA;
            Config.sClientName = "QA CA Benchmark 003 Create New";
            Config.sPlanName = "QA CA Benchmark 003 Create New Plan";
        ...
        public string sOutputFunding_Valuation2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_CA_Benchmark_3\Production\Funding\valuation 12-31-2008\7.2_20180311\";
        public string sOutputAccounting_Valuation2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_CA_Benchmark_3\Production\Accounting\Valuation 12-31-2008\7.2_20180311\";


        String sTable_TBTER_Female = "";
        String sTable_TBTER_Male = "";
        String sTable_TBDISNEW = "";
        String sTable_SALTERM3 = "";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_CA_Benchmark_3\CreateNew\";
                    string sPostFix = _gLib._ReturnDateStampYYYYMMDD() + "_" + Config.eEnv.ToString();

                    //////_gLib._MsgBoxYesNo("Are you sure to create folders under below directory ?", sMainDir);

                    sOutputFunding_Valuation2008 = _gLib._CreateDirectory(sMainDir + "valuation 12-31-2008\\Funding\\" + sPostFix + "\\");
                    sOutputAccounting_Valuation2008 = _gLib._CreateDirectory(sMainDir + "valuation 12-31-2008\\Accounting\\" + sPostFix + "\\");
                }
            ...
            else
            {
                ...
                sOutputFunding_Valuation2008 = _gLib._CreateDirectory(sMainDir + "\\valuation 12-31-2008\\Funding\\");
                sOutputAccounting_Valuation2008 = _gLib._CreateDirectory(sMainDir + "\\valuation 12-31-2008\\Accounting\\");
        ...
        public void test_CA003_CN()
        {

            #region MultiThreads

            Thread thrd_Funding_Valuation2008 = new Thread(() => new CA003_CN().t_CompareRpt_Funding_Valuation2008(sOutputFunding_Valuation2008));
            ...
            dic.Add("ClientCode", "QACA3");
            dic.Add("FiscalYearEnd", "12/31");
            dic.Add("MeasurementDate", "12/31");
            dic.Add("Notes", "Client Owner: Cathy Pickering " + Environment.NewLine + "Date Createed:" + _gLib._ReturnDateStampYYYYMMDD() + Environment.NewLine + Environment.NewLine + "DO NOT TOUCH - BENCHMARK CLIENT");
            ...
            dic.Add("RevCanadaRegistrationNum", "1122");
            dic.Add("ProvincialRegistrationNum", "54646");
            dic.Add("Union", "");
            dic.Add("NonUnion", "");
            dic.Add("Salaried", "");
            dic.Add("Hourly", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\CA003\Data2009.xlsx");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileDefinitionName", "2009Data");
            dic.Add("FileType", "");
            dic.Add("Browse", "Click");
            dic.Add("Preview", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "Data2009.xlsx");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Verify");
            dic.Add("Unique_NoMatch_Num", "2382");
            ...
            dic.Add("Level_3", "GroupLifeOffset");
            pData._TreeViewSelect_Snapshots(dic, true);

            dic.Clear();
            dic.Add("Level_1", "Include all");
            dic.Add("Level_2", "Classification Codes");
            dic.Add("Level_3", "Jobcode");
            pData._TreeViewSelect_Snapshots(dic, true);
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("SnapshotName", "ForCA003Val");
            ...
            dic.Add("Name", "valuation 12/31/2008");
            dic.Add("Parent", "");
            ...
            dic.Add("FundingAL", "13563428");
            dic.Add("FundingNC", "1509685");
            ...
            dic.Add("FundingAL", "2712212");
            dic.Add("FundingNC", "326276");
            dic.Add("AccountingAL", "");
            dic.Add("AccountingNC", "");
            dic.Add("Instance", "2");
            dic.Add("OK", "");
            ...
            dic.Add("FundingAL", "2554322");
            dic.Add("FundingNC", "270393");
            dic.Add("AccountingAL", "");
            dic.Add("AccountingNC", "");
            dic.Add("Instance", "2");
            dic.Add("OK", "");
            ...
            dic.Add("FundingAL", "274773");
            dic.Add("FundingNC", "31050");
            dic.Add("AccountingAL", "");
            dic.Add("AccountingNC", "");
            dic.Add("Instance", "2");
            dic.Add("OK", "click");
            ...
            for (int i = 1; i <= 11; i++)
                sTable_TBTER_Male = sTable_TBTER_Male + "0.066000" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.063200" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.060400" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.057600" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.054800" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.052000" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.049700" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.047400" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.045100" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.042800" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.040500" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.038700" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.036900" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.035100" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.033300" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.031500" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.030400" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.029300" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.028200" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.027100" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.026000" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.024700" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.023400" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.022100" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.020800" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.019500" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.015600" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.011700" + Environment.NewLine;

            sTable_TBTER_Male = sTable_TBTER_Male + "0.007800" + Environment.NewLine;
            sTable_TBTER_Male = sTable_TBTER_Male + "0.003900" + Environment.NewLine;


            for (int i = 1; i <= 11; i++)
                sTable_TBTER_Female = sTable_TBTER_Female + "0.086000" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.082000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.078000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.074000" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.070000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.066000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.063200" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.060400" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.057600" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.054800" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.052000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.049700" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.047400" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.045100" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.042800" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.040500" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.038700" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.036900" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.035100" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.033300" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.031500" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.030400" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.029300" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.028200" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.027100" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.026000" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.024700" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.023400" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.022100" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.020800" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.019500" + Environment.NewLine;

            sTable_TBTER_Female = sTable_TBTER_Female + "0.015600" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.011700" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.007800" + Environment.NewLine;
            sTable_TBTER_Female = sTable_TBTER_Female + "0.003900" + Environment.NewLine;
            ...
            dic.Add("Description", "Cathy Pickering - QA CA Benchmark 3 Table");
            dic.Add("Ultimate", "");
            ...
            dic.Add("sMaleRates", sTable_TBTER_Male);
            dic.Add("sFemaleRates", sTable_TBTER_Female);
            ...
            for (int i = 1; i <= 16; i++)
                sTable_TBDISNEW = sTable_TBDISNEW + "0.000150" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.000160" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000170" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000180" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.000190" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000200" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000250" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.000300" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000350" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000400" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.000450" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000550" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000650" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.000750" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000850" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.000950" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.001100" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.001250" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.001400" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.001550" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.001700" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.001880" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.002060" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.002240" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.002420" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.002600" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.005230" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.007860" + Environment.NewLine;

            sTable_TBDISNEW = sTable_TBDISNEW + "0.010490" + Environment.NewLine;
            sTable_TBDISNEW = sTable_TBDISNEW + "0.013120" + Environment.NewLine;

            for (int i = 1; i <= 5; i++)
                sTable_TBDISNEW = sTable_TBDISNEW + "0.015750" + Environment.NewLine;

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "TBDISNEW");
            ...
            dic.Add("DecimalPlaces", "");
            dic.Add("OK", "Click");
            dic.Add("sUnisexRates", sTable_TBDISNEW);
            dic.Add("sMaleRates", "");
            ...
            for (int i = 1; i <= 11; i++)
                sTable_SALTERM3 = sTable_SALTERM3 + "0.187500" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.180000" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.172500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.165000" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.157500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.150000" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.138750" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.127500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.116250" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.105000" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.093750" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.087750" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.081750" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.075750" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.069750" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.063750" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.062625" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.061500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.060375" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.059250" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.058125" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.057000" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.055875" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.054750" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.053625" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.052500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.052500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.046500" + Environment.NewLine;

            sTable_SALTERM3 = sTable_SALTERM3 + "0.040500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.028500" + Environment.NewLine;
            sTable_SALTERM3 = sTable_SALTERM3 + "0.022500" + Environment.NewLine;

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "SALTERM3");
            dic.Add("Type", "Withdrawal Decrements");
            dic.Add("Description", "Cathy Pickering - QA CA Benchmark 3 Table");
            dic.Add("Ultimate", "");
            dic.Add("Generational", "");
            ...
            dic.Add("DecimalPlaces", "");
            dic.Add("OK", "Click");
            dic.Add("sUnisexRates", sTable_SALTERM3);
            dic.Add("sMaleRates", "");
            dic.Add("sFemaleRates", "");
            pMain._ts_AddTable(dic);
            ...
            #region Funding - Valuation2008 - Assumptions & Provisions
            ...
            pAssumptions._TreeViewRightSelect(dic, "ContserviceGT2");

            dic.Clear();
            dic.Add("Level_1", "Participant Info");
            dic.Add("Level_2", "Eligibilities");
            dic.Add("Level_3", "ContserviceGT2");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Formula", "$ContinuousService >= 2");
            ...
            dic.Add("Level_2", "Eligibilities");
            dic.Add("MenuItem", "Add Eligibilities");
            pAssumptions._TreeViewRightSelect(dic, "ContiServiceGT10");

            dic.Clear();
            dic.Add("Level_1", "Participant Info");
            dic.Add("Level_2", "Eligibilities");
            dic.Add("Level_3", "ContiServiceGT10");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Formula", "$ContinuousService[$ExitAge] >= 10");
            dic.Add("Validate", "Click");
            pEligibilities._PopVerify_Eligibilities(dic);
            ...
            dic.Add("Level_2", "Eligibilities");
            dic.Add("MenuItem", "Add Eligibilities");
            pAssumptions._TreeViewRightSelect(dic, "Atage65");

            dic.Clear();
            dic.Add("Level_1", "Participant Info");
            dic.Add("Level_2", "Eligibilities");
            dic.Add("Level_3", "Atage65");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Formula", "$Age[$ExitAge] >= 65");
            dic.Add("Validate", "Click");
            pEligibilities._PopVerify_Eligibilities(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "ProjectionYMPE");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("UseCurrentYearPayRateFrom", "ValuationPayCurrentYear");
            ...
            dic.Add("cboPreDefinedEligibility", "Atage65");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Adjustments", "");
            dic.Add("RetWithdrawDis", "TBDISNEW");
            pAssumptions._PopVerify_Assmp_Decrement_Parameters(dic);
            ...
            dic.Add("txtLocalEligibility", "Lessthan10yrsservice");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$ContinuousService[$ExitAge] < 10");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "Over55");
            dic.Add("AddToEligibilities", "");
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "Click");
            dic.Add("txtLocalEligibility", "Retirees");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.ParticipantStatus = \"IN\" and $emp.PayStatus = \"PAY\"");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "SalBenefitFormula");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Formulae");
            dic.Add("Level_3", "Career Average Earnings Formula");
            dic.Add("Level_4", "SalBenefitFormula");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("ProjectedSalary", "PayProjection");
            dic.Add("ServiceBasedOn", "ContinuousService");
            ...
            dic.Add("btnC", "");
            dic.Add("btnV", "click");
            dic.Add("sData2", "ProjectionYMPE");
            dic.Add("sData3", "0.012");
            ...
            dic.Add("Level_4", "SalBenefitFormula");
            dic.Add("MenuItem", "Add Condition");
            pAssumptions._TreeViewRightSelect(dic, "Nonupgraded");
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "Nonupgraded");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.JobCode = 1");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "Deferredover65");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Formulae");
            dic.Add("Level_3", "User Defined Projection");
            dic.Add("Level_4", "Deferredover65");
            dic.Add("Level_5", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("iRow", "1");
            dic.Add("Name", "");
            dic.Add("Expression", "$emp.Benefit1DB*((1+$InterestPreCommencement)^Max(0,$ValAge-65)-1)/$InterestPreCommencement");
            dic.Add("Validate", "Click");
            ...
            pAssumptions._TreeViewRightSelect(dic, "GLoffset");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Formulae");
            dic.Add("Level_3", "Custom Formula B");
            dic.Add("Level_4", "GLoffset");
            dic.Add("Level_5", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_4", "GLoffset");
            dic.Add("MenuItem", "Add Condition");
            pAssumptions._TreeViewRightSelect(dic, "twominusglofftimes2timespay");
            ...
            dic.Add("Level_3", "Custom Formula B");
            dic.Add("Level_4", "GLoffset");
            dic.Add("Level_5", "twominusglofftimes2timespay");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("iRow", "1");
            dic.Add("Name", "");
            dic.Add("Expression", "( 2- $emp.GroupLifeOffset) * 2 * $PayProjection");
            dic.Add("Validate", "Click");
            pAssumptions._PopVerify_Provision_CustomCode(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "Click");
            dic.Add("txtLocalEligibility", "twominusglofftimes2timespay");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.JobCode = 1");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("Level_4", "GLoffset");
            dic.Add("MenuItem", "Add Condition");
            pAssumptions._TreeViewRightSelect(dic, "offsetoneandahalftimespay");
            ...
            dic.Add("Level_3", "Custom Formula B");
            dic.Add("Level_4", "GLoffset");
            dic.Add("Level_5", "offsetoneandahalftimespay");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("iRow", "1");
            dic.Add("Name", "");
            dic.Add("Expression", "1.5 * $PayProjection");
            dic.Add("Validate", "Click");
            pAssumptions._PopVerify_Provision_CustomCode(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "Click");
            dic.Add("txtLocalEligibility", "offsetoneandahalftimespay");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.JobCode = 1 and $emp.GroupLifeOffset = 0");
            dic.Add("Validate", "Click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "Planassumptions");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Actuarial Equivalence");
            dic.Add("Level_3", "Planassumptions");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "LifeonlytoJS60");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Conversion Factors");
            dic.Add("Level_3", "LifeonlytoJS60");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_2", "Conversion Factors");
            dic.Add("MenuItem", "Add Conversion Factors");
            pAssumptions._TreeViewRightSelect(dic, "PVlifeonly");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Conversion Factors");
            dic.Add("Level_3", "PVlifeonly");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("txtLocalEligibility", "Over55");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$Age >= 55");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("Level_2", "Form of Payment");
            dic.Add("MenuItem", "Add Form of Payment");
            pAssumptions._TreeViewRightSelect(dic, "Lifeonlywmort");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Form of Payment");
            dic.Add("Level_3", "Lifeonlywmort");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_2", "Form of Payment");
            dic.Add("MenuItem", "Add Form of Payment");
            pAssumptions._TreeViewRightSelect(dic, "Inactiveannuity");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Form of Payment");
            dic.Add("Level_3", "Inactiveannuity");
            dic.Add("MenuItem", "Add Condition");
            pAssumptions._TreeViewRightSelect(dic, "NewSubGroup1");
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "RetireeCO");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.ParticipantStatus = \"IN\" and $emp.PayStatus = \"PAY\" and $emp.PaymentForm1 = \"CO\"");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "RetireeJS");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.ParticipantStatus = \"IN\" and $emp.PayStatus = \"PAY\" and $emp.PaymentForm1 = \"JS\"");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "RetireeLA");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$emp.ParticipantStatus = \"IN\" and $emp.PayStatus = \"PAY\" and $emp.PaymentForm1 = \"LA\"");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "ITAmaximum");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "ITA Maximum Pensions");
            dic.Add("Level_3", "ITAmaximum");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ServiceForCalculation", "ContinuousService");
            ...
            pAssumptions._TreeViewRightSelect(dic, "DB60JS");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Adjustments");
            dic.Add("Level_3", "DB60JS");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_2", "Adjustments");
            dic.Add("MenuItem", "Add Adjustments");
            pAssumptions._TreeViewRightSelect(dic, "AdjustGLoffset");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Adjustments");
            dic.Add("Level_3", "AdjustGLoffset");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("LoadingFactor_T", "");
            dic.Add("LoadingFactor_cboV", "GLoffset");
            dic.Add("LoadingFactor_txt", "");
            dic.Add("LoadingFactor_cboT", "");
            dic.Add("ApplyTo", "Subtract");
            pAdjustments._PopVerify_Main(dic);
            ...
            dic.Add("Level_2", "Adjustments");
            dic.Add("MenuItem", "Add Adjustments");
            pAssumptions._TreeViewRightSelect(dic, "Adjust85formarried");

            dic.Clear();
            dic.Add("Level_1", "Provisions");
            dic.Add("Level_2", "Adjustments");
            dic.Add("Level_3", "Adjust85formarried");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("LoadingFactor_T", "");
            dic.Add("LoadingFactor_cboV", "");
            dic.Add("LoadingFactor_txt", "0.85");
            dic.Add("LoadingFactor_cboT", "");
            dic.Add("ApplyTo", "Benefit before maximum");
            pAdjustments._PopVerify_Main(dic);
            ...
            pAssumptions._TreeViewRightSelect(dic, "ITAmaximumpension");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Max Pension Definition");
            dic.Add("Level_3", "ITAmaximumpension");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("SingleFormulaBenefit", "SalBenefitFormula");
            dic.Add("Function", "");
            dic.Add("Validate", "");
            ...
            dic.Add("MaximumBenefitLimitation", "ITAmaximumpension");
            ...
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Withdrawalbenefit");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("PreDefinedEligibility", "Click");
            dic.Add("cboPreDefinedEligibility", "ContserviceGT2");
            dic.Add("LocalEligibility", "");
            dic.Add("txtLocalEligibility", "");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "");
            ...
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Disabilitybenefit");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Deathbenefit1LS");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Deathbenefit1LS");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ConversionFactor", "PVlifeonly");
            dic.Add("ConversionFactor_Married", "");
            dic.Add("ConversionFactor_Single", "");
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Deathbenefit2JS");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Deathbenefit2JS");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ParticipantType", "");
            dic.Add("SingleFormulaBenefit", "Deathbenefit1LS");
            dic.Add("Function", "");
            dic.Add("Validate", "");
            ...
            dic.Add("EarlyRetirementFactor", "");
            dic.Add("LateRetirementFactor", "");
            dic.Add("AdjustmentFactor", "DB60JS");

            dic.Add("ConversionFactor", "LifeonlytoJS60");
            dic.Add("ConversionFactor_Married", "");
            dic.Add("ConversionFactor_Single", "");
            dic.Add("FormOfPayment", "");
            dic.Add("FormOfPayment_Married", "");
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Deathbenefit3GLoffset");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Deathbenefit3GLoffset");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ParticipantType", "");
            dic.Add("SingleFormulaBenefit", "");
            dic.Add("Function", "Max(0, $Deathbenefit2JS-$AdjustGLoffset) * 0.85");
            dic.Add("Validate", "click");
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Solvencybenefit");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Solvencybenefit");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ConversionFactor_Single", "");
            dic.Add("FormOfPayment", "");
            dic.Add("FormOfPayment_Married", "LifeOnly");
            dic.Add("FormOfPayment_Single", "Lifeonlywmort");
            ...
            dic.Add("ConversionFactor_Married", "");
            dic.Add("ConversionFactor_Single", "");
            dic.Add("FormOfPayment", "Inactiveannuity");
            dic.Add("FormOfPayment_Married", "");
            dic.Add("FormOfPayment_Single", "");
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Deferredpayinactives");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Deferredpayinactives");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("Level_2", "Plan Definition");
            dic.Add("MenuItem", "Add Plan Definition");
            pAssumptions._TreeViewRightSelect(dic, "Deferover65retro");

            dic.Clear();
            dic.Add("Level_1", "Benefit Definition");
            dic.Add("Level_2", "Plan Definition");
            dic.Add("Level_3", "Deferover65retro");
            dic.Add("Level_4", "Default");
            pAssumptions._TreeViewSelect(dic);
            ...
            dic.Add("ParticipantType", "Deferred inactives");
            dic.Add("SingleFormulaBenefit", "Deferredover65");
            dic.Add("Function", "");
            dic.Add("Validate", "");
            ...
            #region Funding - Valuation2008 - Methods
            ...
            _gLib._MsgBox("", "chekc: " + Environment.NewLine + "CostMethod -> Traditional Unit Credit");

            dic.Clear();
            dic.Add("iRow", "2");
            dic.Add("sName", "Solvencybenefit");
            dic.Add("sStatus", "False");
            pMethods._BenefitsToInclude_GoingConcern(dic);

            ////////////pMethods._ResultsForStatisticsForExpected_Grid(1, "#1#", true);
            pMethods._ResultsForStatisticsForExpected_Grid_IR(1, "#1#");


            pMain._Home_ToolbarClick_Top(true);
            _gLib._MsgBox("", "chekc: " + Environment.NewLine + "_ResultsForStatisticsForExpected_Grid_IR-> #1#");
            ...
            dic.Clear();
            dic.Add("iRow", "1");
            dic.Add("sName", "Retirementbenefit");
            ...
            dic.Clear();
            dic.Add("iRow", "3");
            dic.Add("sName", "Withdrawalbenefit");
            dic.Add("sBenefitForCalculation", "False");
            dic.Add("sImmediateVesting", "");
            dic.Add("sCOLA", "");
            pMethods._BenefitsToValueForSolvency(dic);
            ...
            dic.Clear();
            dic.Add("iRow", "4");
            dic.Add("sName", "Deferover65retro");
            dic.Add("sBenefitForCalculation", "true");
            ...
            dic.Clear();
            dic.Add("iRow", "5");
            dic.Add("sName", "Deferredpayinactives");
            dic.Add("sBenefitForCalculation", "true");
            dic.Add("sImmediateVesting", "False");
            dic.Add("sCOLA", "False");
            pMethods._BenefitsToValueForSolvency(dic);
            ...
            #region Funding - Valuation2008 - Test Case & Reports
            ...
            dic.Clear();
            dic.Add("SelectionCriteria", "$emp.birthdate = \"11/11/1965\"");
            dic.Add("iResultRow", "1");
            pTestCaseLibrary._AddTestCase(dic);

            dic.Clear();
            dic.Add("SelectionCriteria", "$emp.hiredate1 = \"02/17/1998\"");
            dic.Add("iResultRow", "1");
            pTestCaseLibrary._AddTestCase(dic);
            ...
            pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Parameter Print", "Conversion", true, true);
            pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Valuation Summary", "Conversion", true, true);

            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Liability Summary", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_Valuation2008, "Liability Summary", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Member Statistics", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_Valuation2008, "Conversion Diagnostic", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Test Case List", "Conversion", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Detailed Results", "Conversion", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Individual Output", "Conversion", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Test Cases", "Conversion", true, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_Valuation2008, "Payout Projection", "Conversion", true, true);
            }

            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Liability Summary", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_Valuation2008, "Liability Summary", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Member Statistics", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutputFunding_Valuation2008, "Conversion Diagnostic", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Test Case List", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Detailed Results", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Detailed Results by Plan Def", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_Valuation2008, "Valuation Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "Individual Output", "Conversion", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_Valuation2008, "IOE", "Conversion", false, true);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_Valuation2008, "Payout Projection", "Conversion", false, true);
            ...
            #region Accounting - Valuation2008
            ...
            dic.Add("ServiceInstance", "valuation 12/31/2008");
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "From60to64");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$Age >= 60 and $Age < 65");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "From55to59");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$Age >= 55 and $Age < 60");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("Adjustments", "");
            dic.Add("RetWithdrawDis", "SALTERM3");
            pAssumptions._PopVerify_Assmp_Decrement_Parameters(dic);
            ...
            dic.Add("cboPreDefinedEligibility", "");
            dic.Add("LocalEligibility", "click");
            dic.Add("txtLocalEligibility", "From55");
            dic.Add("AddToEligibilities", "");
            dic.Add("EligibilityCondition", "$Age >= 55");
            dic.Add("Validate", "click");
            pAssumptions._PopVerify_Assmp_Decrement_Conditions(dic);
            ...
            pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Valuation Summary", "Conversion", true, false);
            pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Parameter Print", "Conversion", true, false);


            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Liability Summary", "Conversion", true, false);
                pOutputManager._ExportReport_DrillDown(sOutputAccounting_Valuation2008, "Liability Summary", "Conversion", true, false, 0);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Member Statistics", "Conversion", true, false);
                pOutputManager._ExportReport_DrillDown(sOutputAccounting_Valuation2008, "Conversion Diagnostic", "Conversion", true, false, 0);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Conversion Diagnostic", "Conversion", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Test Case List", "Conversion", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Detailed Results", "Conversion", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Individual Output", "Conversion", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Test Cases", "Conversion", true, false);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputAccounting_Valuation2008, "Payout Projection", "Conversion", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "FAS Expected Benefit Pmts", "Conversion", true, false);
            }

            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Liability Summary", "Conversion", false, false);
                pOutputManager._ExportReport_DrillDown(sOutputAccounting_Valuation2008, "Liability Summary", "Conversion", false, false, 0);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Member Statistics", "Conversion", false, false);
                pOutputManager._ExportReport_DrillDown(sOutputAccounting_Valuation2008, "Conversion Diagnostic", "Conversion", false, false, 0);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Conversion Diagnostic", "Conversion", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Test Case List", "Conversion", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Detailed Results", "Conversion", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Detailed Results by Plan Def", "Conversion", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "Valuation Summary", "Conversion", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "Individual Output", "Conversion", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_Valuation2008, "IOE", "Conversion", false, false);
                pOutputManager._ExportReport_Others(Config.eCountry, sOutputAccounting_Valuation2008, "Payout Projection", "Conversion", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_Valuation2008, "FAS Expected Benefit Pmts", "Conversion", false, false);
            }


            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("CA003CN", sOutputAccounting_Valuation2008_Prod, sOutputAccounting_Valuation2008);
        ...
        void t_CompareRpt_Funding_Valuation2008(string sOutputFunding_Valuation2008)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("CA003CN", sOutputFunding_Valuation2008_Prod, sOutputFunding_Valuation2008);
