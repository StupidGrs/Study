...
namespace RetirementStudio._TestScripts._TestScripts_Metrix
{
    ...
    /// </summary>
    [CodedUITest]
    public class Metrix_US_1
    {
        public Metrix_US_1()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.US;
            Config.sClientName = "QA Metrix_US_1";
            Config.sPlanName = "QA Metrix_US_1 Plan";
        ...
        public string sOutputFunding_July2008Valuation = "";
        public string sOutputAccounting_July2006FASVal = "";
        public string sOutputAccounting_July2007FASVal = "";
        public string sOutputAccounting_July2008FASVal = "";


        public string sOutputFunding_July2006Valuation_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2006 Valuation\";
        public string sOutputFunding_July2007Valuation_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2007 Valuation\";
        public string sOutputFunding_July2008Valuation_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2008 Valuation\";
        public string sOutputAccounting_July2006FASVal_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2006 FAS Val\";
        public string sOutputAccounting_July2007FASVal_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2007 FAS Val\";
        public string sOutputAccounting_July2008FASVal_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Production\July 2008 FAS Val\";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_Metrix_US_1\Create New\";
                    ...
                    sOutputFunding_July2008Valuation = _gLib._CreateDirectory(sMainDir + "July 2008 Valuation\\" + sPostFix + "\\");
                    ...
                    sOutputAccounting_July2008FASVal = _gLib._CreateDirectory(sMainDir + "July 2008 FAS Val\\" + sPostFix + "\\");
                }
            ...
            else
            {
                ...
                string sMainDir = sDir + "Metrix_US_1_" + _gLib._ReturnDateStampYYYYMMDD();
                ...
                sOutputFunding_July2008Valuation = _gLib._CreateDirectory(sMainDir + "\\Funding_July2008Valuation\\");
                ...
                sOutputAccounting_July2008FASVal = _gLib._CreateDirectory(sMainDir + "\\Accounting_July2008FASVal\\");
            ...
            sContent = sContent + "sOutputFunding_July2008Valuation = @\"" + sOutputFunding_July2008Valuation + "\";" + Environment.NewLine;
            ...
            sContent = sContent + "sOutputAccounting_July2008FASVal = @\"" + sOutputAccounting_July2008FASVal + "\";" + Environment.NewLine;
        ...
        public void test_Metrix_US_1()
        {
            ...
            Thread thrd_Funding_July2006Valuation = new Thread(() => new Metrix_US_1().t_CompareRpt_Funding_July2006Valuation(sOutputFunding_July2006Valuation));
            Thread thrd_Funding_July2007Valuation = new Thread(() => new Metrix_US_1().t_CompareRpt_Funding_July2007Valuation(sOutputFunding_July2007Valuation));
            Thread thrd_Funding_July2008Valuation = new Thread(() => new Metrix_US_1().t_CompareRpt_Funding_July2008Valuation(sOutputFunding_July2008Valuation));
            Thread thrd_Accounting_July2006FASVal = new Thread(() => new Metrix_US_1().t_CompareRpt_Accounting_July2006FASVal(sOutputAccounting_July2006FASVal));
            Thread thrd_Accounting_July2007FASVal = new Thread(() => new Metrix_US_1().t_CompareRpt_Accounting_July2006FASVal(sOutputAccounting_July2007FASVal));
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("CustomClient", "");
            dic.Add("MetrixClient", "True");
            dic.Add("ClientName", "Toshiba America Business Solutions");
            dic.Add("ClientCode", "drum");
            dic.Add("FiscalYearEnd", "06/30");
            dic.Add("MeasurementDate", "09/30");
            dic.Add("Notes", "Metrix client - US, updated from US010");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\Metrix_US010\US0102006.XLs");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\Metrix_US010\US0102007.XLs");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            pMain._PopVerify_FileOpen(dic);
            ...
            dic.Add("EffectiveDate", "07/01/2008");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\Metrix_US010\US0102008.XLs");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            pMain._PopVerify_FileOpen(dic);
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "US0102008.xls");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            pData._PopVerify_IP_SelectFile_FileSelection(dic);
            ...
            dic.Add("Unique_UniqueMatch_Num", "616");
            dic.Add("Unique_MultipleMatches_Num", "0");
            dic.Add("Duplicate_NoMatch_Num", "0");
            dic.Add("Duplicate_UniqueMatch_Num", "0");
            dic.Add("Duplicate_MultipleMatches_Num", "0");
            ...
            #region sOutputFunding_July2008Valuation
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "");
            dic.Add("Name", "July 2008 Valuation");
            dic.Add("Parent", "July 2007 Valuation");
            dic.Add("ParentFinalValuationSet", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", "July 2008 Valuation");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab("July 2008 Valuation");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ValNodeName", "");
            dic.Add("LiabilityValuationDate", "07/01/2008");
            dic.Add("Data_AddNew", "True");
            dic.Add("Data_Name", "Baseline Data");
            dic.Add("Data_Edit", "");
            dic.Add("Assumptions_AddNew", "");
            ...
            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Reconciliation to Prior Year", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Detailed Results", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Status Reconciliation", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Member Statistics", "RollForward", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Individual Checking Template", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Age Service Matrix", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Data Matching Summary", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Combined Status Code Summary", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Gain / Loss Status Reconciliation", "RollForward", true, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Gain / Loss Summary of Liability Reconciliation", "RollForward", true, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Active Decrement Gain / Loss Detail", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Decrement Age", "RollForward", true, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Valuation Summary", "RollForward", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Individual Output", "RollForward", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Parameter Print", "RollForward", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Test Cases", "RollForward", true, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Payout Projection", "RollForward", true, true);
            }

            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Reconciliation to Prior Year", "RollForward", false, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Reconciliation to Prior Year by Plan Def", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Detailed Results", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Detailed Results by Plan Def", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Status Reconciliation", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Member Statistics", "RollForward", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Individual Checking Template", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Age Service Matrix", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Data Matching Summary", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Combined Status Code Summary", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Gain / Loss Status Reconciliation", "RollForward", false, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Gain / Loss Summary of Liability Reconciliation", "RollForward", false, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Active Decrement Gain / Loss Detail", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Decrement Age", "RollForward", false, true);
                pOutputManager._ExportReport_SubReports(sOutputFunding_July2008Valuation, "Gain / Loss Participant Listing", "RollForward", false, true);
                pOutputManager._ExportReport_Common(sOutputFunding_July2008Valuation, "Valuation Summary", "RollForward", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Individual Output", "RollForward", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "IOE", "RollForward", false, true);
                pOutputManager._ExportReport_Others(sOutputFunding_July2008Valuation, "Payout Projection", "RollForward", false, true);
            }


            thrd_Funding_July2008Valuation.Start();
            ...
            thrd_Accounting_July2007FASVal.Start();
            ...
            #region sOutputAccounting_July2008FASVal
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "");
            dic.Add("Name", "July 2008 FAS Val");
            dic.Add("Parent", "July 2007 FAS Val");
            dic.Add("ParentFinalValuationSet", "");
            dic.Add("PlanYearBeginningIn", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", "July 2008 FAS Val");
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab("July 2008 FAS Val");
            ...
            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_SubReports(sOutputAccounting_July2008FASVal, "Reconciliation to Prior Year", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Detailed Results", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Status Reconciliation", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Member Statistics", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Individual Checking Template", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Age Service Matrix", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Data Matching Summary", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Combined Status Code Summary", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Valuation Summary", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Individual Output", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Parameter Print", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Test Cases", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Payout Projection", "RollForward", true, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "FAS Expected Benefit Pmts", "RollForward", true, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Liability Set for Globe Export", "RollForward", true, false);
            }


            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_SubReports(sOutputAccounting_July2008FASVal, "Reconciliation to Prior Year", "RollForward", false, false);
                pOutputManager._ExportReport_SubReports(sOutputAccounting_July2008FASVal, "Reconciliation to Prior Year by Plan Def", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Detailed Results", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Detailed Results by Plan Def", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Status Reconciliation", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Member Statistics", "RollForward", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Individual Checking Template", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Age Service Matrix", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Data Matching Summary", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Combined Status Code Summary", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "Valuation Summary", "RollForward", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Individual Output", "RollForward", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "IOE", "RollForward", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Payout Projection", "RollForward", false, false);
                pOutputManager._ExportReport_Common(sOutputAccounting_July2008FASVal, "FAS Expected Benefit Pmts", "RollForward", false, false);
                pOutputManager._ExportReport_Others(sOutputAccounting_July2008FASVal, "Liability Set for Globe Export", "RollForward", false, false);
            }
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputAccounting_July2008FASVal_Prod, sOutputAccounting_July2008FASVal);
                _compareReportsLib._Report(_PassFailStep.Description, "", "Accounting_July2008FASVal");
        ...
        void t_CompareRpt_Funding_July2006Valuation(string sOutputFunding_July2006Valuation)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputFunding_July2006Valuation_Prod, sOutputFunding_July2006Valuation);
        ...
        void t_CompareRpt_Funding_July2007Valuation(string sOutputFunding_July2007Valuation)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputFunding_July2007Valuation_Prod, sOutputFunding_July2007Valuation);
        ...
        void t_CompareRpt_Funding_July2008Valuation(string sOutputFunding_July2008Valuation)
        {


            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputFunding_July2008Valuation_Prod, sOutputFunding_July2008Valuation);
                _compareReportsLib._Report(_PassFailStep.Description, "", "Funding_July2008Valuation");
                _compareReportsLib.CompareExcel_Exact("ReconciliationtoPriorYear_FAS35PVAB.xlsx", 4, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ReconciliationtoPriorYear_FAS35PVVB.xlsx", 4, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ReconciliationtoPriorYear_PBGCNARPVVB.xlsx", 4, 0, 0, 0);
                _compareReportsLib.CompareExcel_Exact("ReconciliationtoPriorYear_PPANARMax.xlsx", 4, 0, 0, 0);
        ...
        void t_CompareRpt_Accounting_July2006FASVal(string sOutputAccounting_July2006FASVal)
        {
            ...
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputAccounting_July2006FASVal_Prod, sOutputAccounting_July2006FASVal);
        ...
        void t_CompareRpt_Accounting_July2007FASVal(string sOutputAccounting_July2007FASVal)
        {

            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("Metrix_US_1", sOutputAccounting_July2007FASVal_Prod, sOutputAccounting_July2007FASVal);
