...
{
    /// <summary>
    /// Summary description for BR004_RB
    /// </summary>
    [CodedUITest]
    public class BR004_RB
    {
        public BR004_RB()
        {
            Config.eEnv = _TestingEnv.Prod_EU;
            Config.eCountry = _Country.BR;
            Config.sClientName = "QA BR Benchmark 004";
            Config.sPlanName = "QA BR Benchmark 004 Plan";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_004\Production\";
