...
namespace RetirementStudio._TestScripts._TestScripts_BR
{
    ...
    public class BR002_CN
    {
        ...
        public string sOutput_Funding2015_Baseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_002\Production\Funding\Funding2015_Baseline\7.3_20181206_F\";
        public string sOutput_Accounting2015_Baseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_002\Production\Accounting\Accounting2015_Baseline\7.3_20181206_F\";
        ...
        public void test_BR002_CN()
        {
            ...
            dic.Add("ClientCode", "BMBRAZIL2");
            dic.Add("FiscalYearEnd", "12/31");
            dic.Add("MeasurementDate", "09/30");
            dic.Add("Notes", "QA1 ~ Client: SLR BM Brazil 2,  Plan: Brazil BM 02,"
            + Environment.NewLine + " Accounting service / node: 31.12.2015 Accounting / Coding Updates,"
             + Environment.NewLine + "Funding service / node: 31.12.2015 Funding / Coding Updates"

             + Environment.NewLine + Environment.NewLine + "Prod ~ Client: Itau Unibanco S.A,  Plan: PLANO DE APOSENTADORIA COMPLEMENTAR - PAC,  "
             + Environment.NewLine + "Accounting service / node: support 2015 / New Valuation, "
             + Environment.NewLine + "Funding service / node: support 2015 / New Valuation");
            ...
            dic.Add("Label", "CODENQ");
            dic.Add("DisplayName", "CODENQ");
            dic.Add("HistoryLabels", "");
            dic.Add("Monthly", "");
            dic.Add("Yearly", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\BR002\QA1 Data Snapshot.xlsx");
            dic.Add("Open", "Click");
            dic.Add("Cancel", "");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileDefinitionName", "Import Valuation Data");
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("FileName", "QA1DataSnapshot.xlsx");
            dic.Add("OK", "Click");
            dic.Add("Cancel", "");
            ...
            pData._IP_Mapping_MapField("EmployeeIDNumber", "Clean EEID", 0, false);
            pData._IP_Mapping_MapField("CODENQ", "CODENQ", 0, false);
            ...
            dic.Clear();
            dic.Add("PopVerify", "Verify");
            dic.Add("Unique_NoMatch_Num", "7090");
            ...
            dic.Add("Level_5", "BasicPayCurrentYear");
            pData._TreeViewSelect_Snapshots(dic, true);
            ...
            #region Accounting - Accounting2015_Baseline - Table

            pMain._SelectTab("31.12.2015 Accounting");


            string FractionOnSalaryExceedINSS = "";
            _gLib._KillProcessByName("EXCEL");
            MyExcel _excelRead = new MyExcel(@"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\BR002\FractionOnSalaryExceedINSS.xlsx", false);
            _excelRead.OpenExcelFile("Unisex Rates");
            for (int i = 2; i <= 61; i++)
                FractionOnSalaryExceedINSS = FractionOnSalaryExceedINSS + _excelRead.getOneCellValue(i, 2) + Environment.NewLine;
            _excelRead.SaveExcel();
            _excelRead.CloseExcelApplication();

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "FractionOnSalaryExceedINSS");
            ...
            dic.Add("OK", "Click");
            dic.Add("sUnisexRates", FractionOnSalaryExceedINSS);
            dic.Add("sMaleRates", "");
            ...
            string IBGE2013_M = "", IBGE2013_F = "";
            _gLib._KillProcessByName("EXCEL");
            MyExcel _excelRead_IBGE2013 = new MyExcel(@"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\BR002\IBGE2013.xlsx", false);

            _excelRead_IBGE2013.OpenExcelFile("Male Rates");
            for (int i = 2; i <= 122; i++)
                IBGE2013_M = IBGE2013_M + _excelRead_IBGE2013.getOneCellValue(i, 2) + Environment.NewLine;
            _excelRead_IBGE2013.OpenExcelFile("Female Rates");
            for (int i = 2; i <= 122; i++)
                IBGE2013_F = IBGE2013_F + _excelRead_IBGE2013.getOneCellValue(i, 2) + Environment.NewLine;

            //////////////_excelRead_IBGE2013.SaveExcel();
            _excelRead_IBGE2013.CloseExcelApplication();

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "IBGE2013");
            dic.Add("Type", "General");
            dic.Add("Description", "");
            dic.Add("Ultimate", "Click");
            dic.Add("SelectAndUltimate", "");
            ...
            dic.Add("sMaleRates", IBGE2013_M);
            dic.Add("sFemaleRates", IBGE2013_F);
            pMain._ts_AddTable(dic);
            ...
            string ITAU10 = "";
            _gLib._KillProcessByName("EXCEL");
            MyExcel _excelRead_ITAU10 = new MyExcel(@"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\BR002\ITAU10.xlsx", false);

            _excelRead_ITAU10.OpenExcelFile("Unisex Rates");
            for (int j = 2; j <= 107; j++)
            {
                for (int i = 2; i <= 77 - 1; i++)
                    ITAU10 = ITAU10 + _excelRead_ITAU10.getOneCellValue(j, i) + "\t";
                ITAU10 = ITAU10 + _excelRead_ITAU10.getOneCellValue(j, 77) + Environment.NewLine;
            }
            _excelRead_ITAU10.SaveExcel();
            _excelRead_ITAU10.CloseExcelApplication();
            ...
            dic.Add("Description", "");
            dic.Add("Ultimate", "");
            dic.Add("SelectAndUltimate", "true");
            dic.Add("SelectPeriods", "75");
            dic.Add("Generational", "");
            dic.Add("TwoDimensional", "");
            dic.Add("Index1", "Age");
            dic.Add("From1", "15");
            ...
            pTableManager._ts_PasteValue(ITAU10);
            ...
            string LIGHTFRA = "";
            _gLib._KillProcessByName("EXCEL");
            MyExcel _excelRead_LIGHTFRA = new MyExcel(@"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK_CLIENTS_2\QTP_MasterExecution\QDrive\AUTs\RetirementStudio\DataFile\BR002\LIGHTFRA.xlsx", false);

            _excelRead_LIGHTFRA.OpenExcelFile("Unisex Rates");
            for (int i = 2; i <= 107; i++)
                LIGHTFRA = LIGHTFRA + _excelRead_LIGHTFRA.getOneCellValue(i, 2) + Environment.NewLine;

            _excelRead_LIGHTFRA.SaveExcel();
            _excelRead_LIGHTFRA.CloseExcelApplication();

            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("Name", "LIGHTFRA");
            ...
            pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Parameter Print", "Conversion", true, true);
            pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Valuation Summary", "Conversion", true, true);


            if (Config.bDownloadReports_PDF)
            {
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Liability Summary", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutput_Funding2015_Baseline, "Liability Summary", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Member Statistics", "Conversion", true, true);
                pOutputManager._ExportReport_DrillDown(sOutput_Funding2015_Baseline, "Conversion Diagnostic", "Conversion", true, true, 0);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Test Case List", "Conversion", true, true);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Detailed Results", "Conversion", true, true);
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Individual Output", "Conversion", true, true);
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Payout Projection", "Conversion", true, true);
            ...
            if (Config.bDownloadReports_EXCEL)
            {
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Liability Summary", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutput_Funding2015_Baseline, "Liability Summary", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Member Statistics", "Conversion", false, true);
                pOutputManager._ExportReport_DrillDown(sOutput_Funding2015_Baseline, "Conversion Diagnostic", "Conversion", false, true, 0);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Test Case List", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Detailed Results", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Detailed Results by Plan Def", "Conversion", false, true);
                pOutputManager._ExportReport_Common(sOutput_Funding2015_Baseline, "Valuation Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Individual Output", "Conversion", false, true);
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "IOE", "Conversion", false, true);
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Payout Projection", "Conversion", false, true);
            }
