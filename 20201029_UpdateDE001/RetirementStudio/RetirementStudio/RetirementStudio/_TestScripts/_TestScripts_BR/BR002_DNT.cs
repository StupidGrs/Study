...
namespace RetirementStudio._TestScripts._TestScripts_BR
{
    ...
    public class BR002_DNT
    {
        public BR002_DNT()
        {
            ...
            Config.sClientName = "QA BR Benchmark 002 Existing DNT";
            Config.sPlanName = "QA BR Benchmark 002 Existing DNT Plan";
        ...
        //2\Production\Accounting\Accounting2015_Baseline\6.8_20160316
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_002\Existing\";
        ...
        public void test_BR002_DNT()
        {


            #region MultiThreads

            Thread thrd_Funding2015_Baseline = new Thread(() => new BR002_DNT().t_CompareRpt_Funding2015_Baseline(sOutput_Funding2015_Baseline));
            ...
            #region Funding - Funding2015_Baseline
            ...
            if (Config.bDownloadReports_PDF)
            {
                ...
                pOutputManager._ExportReport_Others(sOutput_Funding2015_Baseline, "Test Cases", "Conversion", true, true);
            ...
            thrd_Funding2015_Baseline.Start();
            ...
            #region Accounting - Accounting2015_CodingUpdates
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("BR002_DNT", sOutput_Accounting2015_Baseline_Prod, sOutput_Accounting2015_Baseline);
        ...
        public void t_CompareRpt_Funding2015_Baseline(string sOutput_Funding2015_Baseline)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("BR002_DNT", sOutput_Funding2015_Baseline_Prod, sOutput_Funding2015_Baseline);
