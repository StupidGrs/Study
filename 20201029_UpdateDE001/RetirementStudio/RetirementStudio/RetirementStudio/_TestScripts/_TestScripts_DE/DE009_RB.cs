...
{
    /// <summary>
    /// Summary description for DE009_RB
    /// </summary>
    [CodedUITest]
    public class DE009_RB
    {
        public DE009_RB()
        {
            Config.eEnv = _TestingEnv.Prod_EU;
            Config.eCountry = _Country.DE;
            Config.sClientName = "QA DE Benchmark 009 E";
            Config.sPlanName = "Alle - QA DE Benchmark 009 E";
            //Config.sClientName = "QA DE Benchmark 009";
            //Config.sPlanName = "Alle - QA DE Benchmark 009";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            {
                string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_009\Production\";
