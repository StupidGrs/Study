...
namespace RetirementStudio._TestScripts._TestScripts_Data
{
    ...
    public class DE012
    {
        ...
        public void test_DE012()
        {
            ...
            if (Config.bDownloadReports_PDF)
                pOutputManager._ExportReport_DrillDown(Config.eCountry, sOutput_Data2012, "Valuation Summary", "Conversion", true, false, 0, new string[1] { "ALL" });

            if (Config.bDownloadReports_EXCEL)
                pOutputManager._ExportReport_DrillDown(Config.eCountry, sOutput_Data2012, "Valuation Summary", "Conversion", false, false, 0, new string[1] { "ALL" });
            ...
            if (Config.bDownloadReports_PDF)
                pOutputManager._ExportReport_DrillDown(Config.eCountry, sOutput_Data2013, "Valuation Summary", "RollForward", true, false, 0, new string[1] { "ALL" });

            if (Config.bDownloadReports_EXCEL)
                pOutputManager._ExportReport_DrillDown(Config.eCountry, sOutput_Data2013, "Valuation Summary", "RollForward", false, false, 0, new string[1] { "ALL" });
