...
{
    /// <summary>
    /// Summary description for ANZ001_RB
    /// </summary>
    [CodedUITest]
    public class ANZ001_RB
    {
        public ANZ001_RB()
        {
            Config.eEnv = _TestingEnv.Prod_US;
            Config.eCountry = _Country.ANZ;
            Config.sClientName = "QA ANZ Benchmark 001";
            Config.sPlanName = "QA ANZ Benchmark 001";
            ////Config.sClientName = "QA ANZ Benchmark 001 D";
            ////Config.sPlanName = "QA ANZ Benchmark 001 D";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            {
                string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_ANZ_001_Adelaide_Brighton\Production\Accounting 2014\";
                ...
                sOutputAccounting_Accounting2014 = _gLib._CreateDirectory(sMainDir + sPostFix);
