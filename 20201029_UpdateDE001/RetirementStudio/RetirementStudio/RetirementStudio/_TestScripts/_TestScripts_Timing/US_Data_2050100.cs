////// ----------------------- ------------------------------------------------------------------------///////////
//////                         US Data Performance Test 20K 50K 100K phase2                            ///////////
//////                                                                                                 ///////////
//////                          Webber.ling@mercer.com      2015-Dec-02                                ///////////
//////                                                                                                 ///////////
////// ----------------------------------------------------------------------------------------------- ///////////
...
{
    /// <summary>
    /// Summary description for US_Data_2050100
    /// </summary>
    [CodedUITest]
    public class US_Data_2050100
    {
        public US_Data_2050100()
        {
            Config.eEnv = _TestingEnv.QA1;
            Config.eCountry = _Country.US;
            Config.sClientName = "Data_100K_20140327_B";
            //Config.sPlanName = "QA Data Performance Test 001";
        ...
        public void test_US_Data_2050100()
        {
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Invalid or no pay", "426");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Invalid or no pay", "105");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Invalid or no pay", "4445");
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Accrued benefit change", "1504");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Accrued benefit change", "5639");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Earnings and Accrued Benefit Checks => Accrued benefit change", "12181");
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no pension amount, new inactive", "64");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no pension amount, new inactive", "271");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no pension amount, new inactive", "510");
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no retirement date, in pay inactive", "40");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no retirement date, in pay inactive", "163");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => Invalid or no retirement date, in pay inactive", "299");
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => No form of payment, new inactive", "7");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => No form of payment, new inactive", "3");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "New Inactive Checks => No form of payment, new inactive", "3");
            ...
            if (sEENum.Equals("20K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Service Checks => Invalid or no Hire Date", "28");
            if (sEENum.Equals("50K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Service Checks => Invalid or no Hire Date", "0");
            if (sEENum.Equals("100K"))
                pData._CK_CheckGrip_ClickLink_Fail("Data2012", "Service Checks => Invalid or no Hire Date", "0");
            ...
            #region Undo - BatchUpdate, View&Update, Reports, SimpleImport, Snapshot
