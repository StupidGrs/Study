...
namespace RetirementStudio._TestScripts._TestScripts_Timing
{
    ...
    public class US_Timing_GainLoss
    {
        ...
        public void test_US_Timing_GainLoss()
        {
            ...
            pOutputManager._ExportReport_SubReports(sOutputDir, "Gain / Loss Participant Listing", "RollForward", false, true);
            ...
            pMain._SelectTab("Output Manager");
            mTime.StartTimer();
            pOutputManager._ExportReport_SubReports(sOutputDir, "Gain / Loss Summary of Liability Reconciliation", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Others(sOutputDir, "IOE", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Others(sOutputDir, "Payout Projection", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common(sOutputDir, "Valuation Summary", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_SubReports(sOutputDir, "Reconciliation to Baseline", "RollForward", false, true);
            ...
            pOutputManager._ExportReport_Common(sOutputDir, "Liabilities Detailed Results", "RollForward", false, true);
