...
namespace RetirementStudio._Config
{
    ...
    public enum _Country { US, CA, DE, UK, NL, IR }

    public enum _BenchmarkUser { Anya, Cindy, Shane, Webber, Yolanda, Others }
    ...
    class Config
    {
        ...
        public static int iER_CompleteTime = 1200;
