...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _US014_CN
    {
        ...
        public string sService_Funding_Conversion = "";
        ...
        public void _test_US014_CN()
        {
            sOutputBaseline = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_014_EAN\Create New\Conversion\20190925_QA1\";


            sService_Funding_Conversion = "Conversion_20190925";
            ...
            //dic.Add("Name", sService_Funding_Conversion);
            //dic.Add("Parent", "");
            ...
            //dic.Add("ServiceToOpen", sService_Funding_Conversion);
            //pMain._PopVerify_Home_RightPane(dic);

            //pMain._SelectTab(sService_Funding_Conversion);
