...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _DE007_CN
    {
        ...
        public string sService_Pension_Strichtag2011 = "";
        ...
        public void _test_DE007_CN()
        {
            sService_Pension_Strichtag2011 = "Stichtag 2011Final_20190813";
           ...
           dic.Add("Name", sService_Pension_Strichtag2011);
           ...
           dic.Add("ServiceToOpen", sService_Pension_Strichtag2011);
           dic.Add("CheckPopup", "False");
           pMain._PopVerify_Home_RightPane(dic);


           pMain._SelectTab(sService_Pension_Strichtag2011);
