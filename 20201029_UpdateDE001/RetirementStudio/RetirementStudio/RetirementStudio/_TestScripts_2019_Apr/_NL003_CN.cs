...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _NL003_CN
    {
        public _NL003_CN()
        {
            ...
            Config.sClientName = "QA NL Benchmark 003 Create New_Permanent";
            Config.sPlanName = "QA NL Benchmark 003 Create New Plan";
        ...
        public string sAccounting_Valuation2009_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_NL_Benchmark_003\Production\7.3.2_20181121_B\";
        ...
        public void _test_NL003_CN()
        {
            ...
            _gLib._MsgBoxYesNo("Only use client: " + Config.sClientName, "Delete the Service \"Valuation 2009\"");
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sAccounting_Valuation2009, "Liability Summary", "Conversion", true, false);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sAccounting_Valuation2009, "Liability Summary", "Conversion", true, false, 0);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "Member Statistics", "Conversion", true, false);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sAccounting_Valuation2009, "Conversion Diagnostic", "Conversion", true, false, 0);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sAccounting_Valuation2009, "Conversion Diagnostic", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "Test Case List", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "Detailed Results", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "Detailed Results by Plan Def", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "Valuation Summary", "Conversion", true, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sAccounting_Valuation2009, "Individual Output", "Conversion", true, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sAccounting_Valuation2009, "IOE", "Conversion", true, false);
            pOutputManager._ExportReport_Others_PDF_EXCEL(sAccounting_Valuation2009, "Payout Projection", "Conversion", true, false);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Valuation2009, "FAS Expected Benefit Pmts", "Conversion", true, false);
