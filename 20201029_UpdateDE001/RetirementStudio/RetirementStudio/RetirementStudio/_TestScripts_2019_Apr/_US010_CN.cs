...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _US010_CN
    {
        ...
        public string sService_July2007_Val = "July2007_Val_1";
        public string sService_July2007_FASVal = "July2007_FASVal_1";
        ...
        public void _test_US010_CN()
        {


            sService_July2007_Val = "July2007_Val_20190925";
            sService_July2007_FASVal = "July2007_FASVal_20190925";


            #region MultiThreads


            Thread thrd_Funding_July2007Valuation = new Thread(() => new _US010_CN().t_CompareRpt_Funding_July2007Valuation(sOutputFunding_July2007Valuation));
            ...
            dic.Add("Name", sService_July2007_Val);
            dic.Add("Parent", "July 2006 Valuation");
            ...
            dic.Add("ServiceToOpen", sService_July2007_Val);
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_July2007_Val);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "");
            dic.Add("Name", sService_July2007_FASVal);
            dic.Add("Parent", "July 2006 FAS Val");
            dic.Add("ParentFinalValuationSet", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_July2007_FASVal);
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab(sService_July2007_FASVal);
