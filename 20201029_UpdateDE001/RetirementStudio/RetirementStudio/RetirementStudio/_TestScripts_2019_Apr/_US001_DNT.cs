...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _US001_DNT
    {
        ...
        public string sOutputBaseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_001_Saks_PIA_1_ReduceBen\Production\PIA_1\7.4_20190409_Franklin\Baseline\";
        ...
        public void _test_US001_DNT()
        {
            ...
            _gLib._MsgBoxYesNo("", "Right select \"Run - Liabilities\" under Node \"US 002\"");
            ...
            _gLib._MsgBoxYesNo("", "Right select \"View Run Status\" under Node \"US 002\"");
            ...
            _gLib._MsgBoxYesNo("", "Right select \"View Output\" under Node \"US 002\"");
            ...
            _gLib._MsgBoxYesNo("PIA_1 - US 002", "Finished!!");
