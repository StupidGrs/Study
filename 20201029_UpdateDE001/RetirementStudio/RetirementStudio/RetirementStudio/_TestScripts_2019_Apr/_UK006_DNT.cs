...
{
    /// <summary>
    /// Summary description for _UK006_DNT
    /// </summary>
    [CodedUITest]
    public class _UK006_DNT
    {
        public _UK006_DNT()
        {
        ...
        public string sOutputFunding_Valuation2009_Baseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_006\Existing\Funding\Valuation 2009\Baseline\000_7.4_Baseline\";
        public string sOutputFunding_Valuation2009_WithAltFunding_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_006\Existing\Funding\Valuation 2009\With Alt Funding\000_7.4_Baseline\";
        public string sOutputAccounting_Accounting2008_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_006\Existing\Accounting\Accounting2008\000_7.4_Baseline\";
        ...
        public void CodedUITestMethod1()
        {
            ...
            Thread thrd_Valuation2009_Baseline = new Thread(() => new _UK006_DNT().t_CompareRpt_Valuation2009_Baseline(sOutputFunding_Valuation2009_Baseline));
            Thread thrd_Valuation2009_WithAltFunding = new Thread(() => new _UK006_DNT().t_CompareRpt_Valuation2009_WithAltFunding(sOutputFunding_Valuation2009_WithAltFunding));
            ...
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(sOutputFunding_Valuation2009_Baseline, "Gain / Loss Participant Listing", "RollForward", false, true);
