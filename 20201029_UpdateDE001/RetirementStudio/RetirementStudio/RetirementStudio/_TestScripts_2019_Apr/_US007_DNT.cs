...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _US007_DNT
    {
        ...
        public void _test_US007_DNT()
        {

            sOutputFunding2006 = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\Funding 2006\20190618_QA1\";
            sOutputAccounting2006 = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_007_Keihin\Existing\2006 Accounting\20190618_QA1\";


            #region MultiThreads
            
            //Thread thrd_Funding2005 = new Thread(() => new _US007_DNT().t_CompareRpt_Funding2005(sOutputFunding2005));
            Thread thrd_Funding2006 = new Thread(() => new _US007_DNT().t_CompareRpt_Funding2006(sOutputFunding2006));
            //Thread thrd_Accounting2005 = new Thread(() => new _US007_DNT().t_CompareRpt_Accounting2005(sOutputAccounting2005));
