...
{
    /// <summary>
    /// Summary description for _BR004_DNT
    /// </summary>
    [CodedUITest]
    public class _BR004_DNT
    {
        public _BR004_DNT()
        {
        ...
        public void Test_BR004_DNT()
        {
            ...
            Thread thrd_Accounting2015 = new Thread(() => new _BR004_DNT().t_CompareRpt_Valuation2011_Baseline(sAccounting_Accounting2015));
