...
{
    /// <summary>
    /// Summary description for _BR002_DNT
    /// </summary>
    [CodedUITest]
    public class _BR002_DNT
    {
        public _BR002_DNT()
        {
        ...
        public void Test_BR002_DNT()
        {
            ...
            Thread thrd_Funding2015_Baseline = new Thread(() => new _BR002_DNT().t_CompareRpt_Funding2015_Baseline(sOutput_Funding2015_Baseline));
