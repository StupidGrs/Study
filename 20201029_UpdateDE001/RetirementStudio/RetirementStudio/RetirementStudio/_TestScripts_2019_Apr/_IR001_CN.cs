...
{
    /// <summary>
    /// Summary description for _IR001_CN
    /// </summary>
    [CodedUITest]
    public class _IR001_CN
    {
        public _IR001_CN()
        {
        ...
        public string sService_Funding_2010Valuation = "2010Valuation_CN";
        public string sService_Funding_FASValuation2010 = "FAS2010Valuation_CN";
        ...
        public void _test_IR001_CN()
        {

            #region MultiThreads

            Thread thrd_2010Valuation_Baseline = new Thread(() => new _IR001_CN().t_CompareRpt_2010Valuation_Baseline(sOutputFunding_2010Valuation_Baseline));
            Thread thrd_2010Valuation_AddDecrements = new Thread(() => new _IR001_CN().t_CompareRpt_2010Valuation_AddDecrements(sOutputFunding_2010Valuation_AddDecrements));
            Thread thrd_FASValuation2010_Baseline = new Thread(() => new _IR001_CN().t_CompareRpt_FASValuation2010_Baseline(sOutputAccounting_FASValuation2010_Baseline));
            ...
            dic.Add("Name", sService_Funding_2010Valuation);
            ...
            dic.Add("ServiceToOpen", sService_Funding_2010Valuation);
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab(sService_Funding_2010Valuation);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "");
            dic.Add("Name", sService_Funding_FASValuation2010);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Funding_FASValuation2010);
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab(sService_Funding_FASValuation2010);
