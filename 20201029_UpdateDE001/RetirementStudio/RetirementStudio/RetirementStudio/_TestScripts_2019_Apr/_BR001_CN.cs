...
{
    /// <summary>
    /// Summary description for _BR001_CN
    /// </summary>
    [CodedUITest]
    public class _BR001_CN
    {
        public _BR001_CN()
        {
        ...
        public string sService_Funding = "Fnd2015_1";
        ...
        public void Test_BR001_CN()
        {
            ...
            Thread thrd_Accounting2015 = new Thread(() => new _BR001_CN().t_CompareRpt_Accounting2015(sAccounting_Accounting2015));
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Funding);
            pMain._PopVerify_Home_RightPane(dic);
            ...
            pMain._SelectTab(sService_Funding);
            ...
            dic.Add("ServiceInstance", sService_Accounting);
        ...
        public void t_CompareRpt_Accounting2015(string sAccounting_Accounting2015)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("_BR001CN", sAccounting_Accounting2015_Prod, sAccounting_Accounting2015);
