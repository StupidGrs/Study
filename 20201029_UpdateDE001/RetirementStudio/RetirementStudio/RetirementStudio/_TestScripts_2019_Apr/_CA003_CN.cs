...
{
    /// <summary>
    /// Summary description for _CA003_CN
    /// </summary>
    [CodedUITest]
    public class _CA003_CN
    {
        public _CA003_CN()
        {
        ...
        public string sService_Funding_Valuation2008 = "";
        public string sService_Accounting_Valuation2008 = "";
        ...
        public void _test_CA003_CN()
        {

            sService_Funding_Valuation2008 = "valuation 12/31/2008-20190920";
            sService_Accounting_Valuation2008 = "valuation 12/31/2008-20190920";


            #region MultiThreads

            Thread thrd_Funding_Valuation2008 = new Thread(() => new _CA003_CN().t_CompareRpt_Funding_Valuation2008(sOutputFunding_Valuation2008));
            ...
            dic.Add("Name", sService_Funding_Valuation2008);
            dic.Add("Parent", "");
            ...
            dic.Add("ServiceToOpen", sService_Funding_Valuation2008);
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab(sService_Funding_Valuation2008);
            ...
            pMethods._ResultsForStatisticsForExpected_Grid_IR(1, "SalBenefitFormula");


            pMain._Home_ToolbarClick_Top(true);
            _gLib._MsgBox("", "chekc: " + Environment.NewLine + "_ResultsForStatisticsForExpected_Grid_IR->  SalBenefitFormula");
            ...
            pMain._Home_ToolbarClick_Top(true);
            _gLib._MsgBox("", "check and make sure " + Environment.NewLine + "GoingConcern-> CostMethod -> Traditional Unit Credit");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "True");
            dic.Add("Name", sService_Accounting_Valuation2008);
            dic.Add("Parent", "");
            dic.Add("ParentFinalValuationSet", "");
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Accounting_Valuation2008);
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Accounting_Valuation2008);
            ...
            dic.Add("ServiceInstance", sService_Accounting_Valuation2008);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputAccounting_Valuation2008, "Payout Projection", "Conversion", false, false);
