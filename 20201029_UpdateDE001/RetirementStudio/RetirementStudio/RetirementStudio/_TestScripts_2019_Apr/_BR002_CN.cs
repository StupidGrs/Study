...
{
    /// <summary>
    /// Summary description for _BR002_CN
    /// </summary>
    [CodedUITest]
    public class _BR002_CN
    {
        public _BR002_CN()
        {
        ...
        public void Test_BR002_CN()
        {
            ...
            Thread thrd_Accounting2015_Baseline = new Thread(() => new _BR002_CN().t_CompareRpt_Accounting2015_Baseline(sOutput_Accounting2015_Baseline));
            ...
            #region Funding - Baseline - ParticipantData
            ...
            #region Funding - Baseline - Assumptions & Provisions
            ...
            #region Funding - Baseline - Methods
            ...
            #region Funding - Baseline - TestCase
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("_BR002_CN", sOutput_Funding2015_Baseline_Prod, sOutput_Funding2015_Baseline);
