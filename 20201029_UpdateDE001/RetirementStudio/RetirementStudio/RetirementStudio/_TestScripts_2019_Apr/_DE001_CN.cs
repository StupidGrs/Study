...
{
    /// <summary>
    /// Summary description for _DE001_CN
    /// </summary>
    [CodedUITest]
    public class _DE001_CN
    {
        public _DE001_CN()
        {
        ...
        public string sService_Pension_Pension2009_new = "Pension2009_1";
        public string sService_Jubilee_Jubilee2009_new = "Jubilee2009_1";
        ...
        public void _test_DE001_CN()
        {


            sService_Pension_Pension2009_new = "Pension2009_20190923";
            sService_Jubilee_Jubilee2009_new = "Jubilee2009_20190923";

             
            #region MultiThreads

            Thread thrd_Pension2009 = new Thread(() => new _DE001_CN().t_CompareRpt_Pension2009(sOutputPension_Pension2009));
            Thread thrd_Jubilee2009_Baseline = new Thread(() => new _DE001_CN().t_CompareRpt_Jubilee2009_Baseline(sOutputJubilee_Jubilee2009_Baseline));
            ...
            dic.Add("Name", sService_Pension_Pension2009_new);
            ...
            dic.Add("ServiceToOpen", sService_Pension_Pension2009_new);
            ...
            pMain._SelectTab(sService_Pension_Pension2009_new);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("ConversionService", "");
            dic.Add("Name", sService_Jubilee_Jubilee2009_new);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Jubilee_Jubilee2009_new);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);
            ...
            pMain._SelectTab(sService_Jubilee_Jubilee2009_new);
