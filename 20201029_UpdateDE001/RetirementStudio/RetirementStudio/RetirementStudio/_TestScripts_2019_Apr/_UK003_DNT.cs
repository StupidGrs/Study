...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _UK003_DNT
    {
        ...
        public void _test_UK003_DNT()
        {

            #region MultiThreads

            Thread thrd_Valuation2014_Baseline = new Thread(() => new _UK003_DNT().t_CompareRpt_Valuation2014_Baseline(sOutputFunding_Valuation2014_Baseline));

            #endregion

            sOutputFunding_Valuation2014_Baseline = @"";
            sOutputFunding_Valuation2014_FVGrowthPCT = @"";
            ...
            _gLib._MsgBox("", "Please run Funding>Valuation2014_FVGrowthPCT liability.");
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Data Matching Summary", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Combined Status Code Summary", "RollForward", true, true);
