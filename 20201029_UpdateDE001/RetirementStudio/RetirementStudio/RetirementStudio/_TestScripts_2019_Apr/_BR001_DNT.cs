...
{
    /// <summary>
    /// Summary description for _BR001_DNT
    /// </summary>
    [CodedUITest]
    public class _BR001_DNT
    {
        public _BR001_DNT()
        {
            ...
            Config.sClientName = "QA BR Benchmark 001 Existing DNT";
            Config.sPlanName = "QA BR Benchmark 001 Existing DNT Plan";
            //Config.sClientName = "SLR BM Brazil";
            //Config.sPlanName = "Brazil BM 01";
        ...
        public string sFunding_Funding2015_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_001\Production\Funding\Funding2015\7.4_20190410_Franklin\";
        public string sAccounting_Accounting2015_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_001\Production\Accounting\Accounting2015\7.4_20190410_Franklin\";
        ...
        public void GenerateReportOuputDir()
        {
            ...
            if (!Config.bReportsStoreLocal)
            {
                ...
                {
                    string sMainDir = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BR_Benchmark_001\Existing\";
        ...
        public void Test_BR001_DNT()
        {

            #region MultiThreads

            Thread thrd_Accounting2015 = new Thread(() => new _BR001_DNT().t_CompareRpt_Accounting2015(sAccounting_Accounting2015));
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sFunding_Funding2015, "Valuation Summary", "Conversion", true, false);
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("BR001DNT", sFunding_Funding2015_Prod, sFunding_Funding2015);
        ...
        public void t_CompareRpt_Accounting2015(string sAccounting_Accounting2015)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("BR001DNT", sAccounting_Accounting2015_Prod, sAccounting_Accounting2015);
