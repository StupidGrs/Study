...
namespace RetirementStudio._TestScripts._TestScripts_UK
{
    ...
    public class _UK003_CN
    {
        ...
        public string sService_Funding_Valuation2014 = "";


        public string sOutputFunding_Valuation2014_Baseline_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_003\Production\Funding\Valuation 2014\Baseline\7.3.2_20181122_E\";
        public string sOutputFunding_Valuation2014_FVGrowthPCT_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_003\Production\Funding\Valuation 2014\FV GrowthPCT\7.3.2_20181122_E\";
        ...
        public void _test_UK003_CN()
        {
            #region MultiThreads

            Thread thrd_Valuation2014_Baseline = new Thread(() => new _UK003_CN().t_CompareRpt_Valuation2014_Baseline(sOutputFunding_Valuation2014_Baseline));

            #endregion
            

            sService_Funding_Valuation2014 = "Valuation 2014_2019testing";
            ...
            dic.Add("Name", sService_Funding_Valuation2014);
            ...
            dic.Add("ServiceToOpen", sService_Funding_Valuation2014);
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Funding_Valuation2014);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Valuation Summary", "RollForward", true, true);
            ...
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Reconciliation to Prior Year", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Detailed Results", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Status Reconciliation", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Member Statistics", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Individual Checking Template", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Age Service Matrix", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_Baseline, "Individual Output", "RollForward", true, true);
            ...
            _gLib._MsgBox("", "Please go to ValuationProcessControl, change Funding service in the VPC2014 property to the new added funding service.");
            ...
            _gLib._MsgBox("", "Please go to ValuationProcessControl, change Funding service in the VPC2014 property to the original value.");
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Valuation Summary", "RollForward", true, true);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Future Valuation Summary", "RollForward", true, true);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Individual Output", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Payout Projection - Benefit Cashflows", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Payout Projection - Other Info", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Liabilities Detailed Results", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Future Valuation Population Projection", "RollForward", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2014_FVGrowthPCT, "Future Valuation Liabilities Detailed Results", "RollForward", true, true);
