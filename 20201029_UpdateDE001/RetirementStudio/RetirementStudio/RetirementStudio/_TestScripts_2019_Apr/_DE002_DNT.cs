...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _DE002_DNT
    {
        ...
        public void _test_DE002_DNT()
        {
            ...
            sOutputPension_ChristianVal = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_002\Existing DNT\";


            #region Pension Valuation - ChristianVal - Baseline - Run ER
            ...
            #region Pension Valuation - ChristianVal - Baseline - Reports
            ...
            //_gLib._MsgBox("ChristianVal - Baseline", "Reports Finished!");

            #endregion


            #region Pension Valuation - ChristianVal - Baseline - CompareReports
            ...
            if (Config.bCompareReports)
            {
                ...
                _gLib._MsgBox("ChristianVal - Baseline", "Compare Reports Finished!");
