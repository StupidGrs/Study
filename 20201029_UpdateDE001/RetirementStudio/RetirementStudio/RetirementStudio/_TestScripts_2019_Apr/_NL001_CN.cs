...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _NL001_CN
    {
        ...
        public string sOutputFunding_Fnd2011Cnv_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_NL_Benchmark_001\Existing\Funding\Fnd2011Cnv\000_7.4_Baseline\";
        ...
        public void _test_NL001_CN()
        {

            string sAccounting_Acct2011Cnv = "Acct2011Cnv-20190808";
            string sService_Fnd2012RF = "Fnd2012RF-20190808";

 
            #region MultiThreads

            Thread thrd_Acct2011Cnv = new Thread(() => new _NL001_CN().t_CompareRpt_Acct2011Cnv(sOutputAccounting_Acct2011Cnv));
            Thread thrd_Fnd2011Cnv = new Thread(() => new _NL001_CN().t_CompareRpt_Fnd2011Cnv(sOutputFunding_Fnd2011Cnv));
            Thread thrd_Fnd2012RF_Baseline = new Thread(() => new _NL001_CN().t_CompareRpt_Fnd2012RF_Baseline(sOutputFunding_Fnd2012RF_Baseline));
            ...
            dic.Add("Name", sAccounting_Acct2011Cnv);
            dic.Add("Parent", "");
            ...
            dic.Add("ServiceToOpen", sAccounting_Acct2011Cnv);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sAccounting_Acct2011Cnv);
            ...
            dic.Add("Name", sService_Fnd2012RF);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Fnd2012RF);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Fnd2012RF);
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("NL001CN", sOutputFunding_Fnd2012RF_FndChld1_Prod, sOutputFunding_Fnd2012RF_FndChld1);
        ...
        public void t_CompareRpt_Acct2011Cnv(string sOutputAccounting_Acct2011Cnv)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("NL001CN", sOutputAccounting_Acct2011Cnv_Prod, sOutputAccounting_Acct2011Cnv);
        ...
        public void t_CompareRpt_Fnd2011Cnv(string sOutputFunding_Fnd2011Cnv)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("NL001CN", sOutputFunding_Fnd2011Cnv_Prod, sOutputFunding_Fnd2011Cnv);
        ...
        public void t_CompareRpt_Fnd2012RF_Baseline(string sOutputFunding_Fnd2012RF_Baseline)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("NL001CN", sOutputFunding_Fnd2012RF_Baseline_Prod, sOutputFunding_Fnd2012RF_Baseline);
