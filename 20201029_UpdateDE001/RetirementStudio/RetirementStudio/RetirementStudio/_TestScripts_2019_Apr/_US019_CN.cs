...
namespace RetirementStudio._TestScripts._TestScripts_US
{
    ...
    public class _US019_CN
    {
        ...
        public string sService_Accounting_2019FutVal = "";
        public string sNode_Funding_2018FundingValuation_FurValrun = "";
        ...
        public string sFunding2018_FutureValRun_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_019_PPA\Production\Funding\1.1.2018 Funding Valuation\Future Val Run\7.4_20190409_Dallas\";
        ...
        public string sAccounting2018_FutureValRun_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_019_PPA\Production\Accounting\1.1.2018 Accounting Valuation\Future Val Run\7.4_20190409_Dallas\";
        ...
        public void _test_US019_CN()
        {
            ...
            Thread thrd_Funding2018_FutureValRun = new Thread(() => new _US019_CN().t_CompareRpt_Funding2018_FutureValRun(sFunding2018_FutureValRun));
            ...
            sService_Accounting_2019FutVal = "2018 Accounting val_20190822";
            sNode_Funding_2018FundingValuation_FurValrun = "Future Val Run_20190822";


            #region 2018 funding val_2019testing - Future Val Run node
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("ValNodeName", sNode_Funding_2018FundingValuation_FurValrun);
            dic.Add("LiabilityValuationDate", "");
            dic.Add("Data_AddNew", "");
            dic.Add("Data_Name", "");
            dic.Add("Data_Edit", "");
            dic.Add("Assumptions_AddNew", "True");
            dic.Add("Assumptions_Name", sNode_Funding_2018FundingValuation_FurValrun);
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select Assumptions>Edit Parameter for the " + sNode_Funding_2018FundingValuation_FurValrun);
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select Future Valuation Options");
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select run>Future Valuation Population Projection for" + sNode_Funding_2018FundingValuation_FurValrun);
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select View run Status for" + sNode_Funding_2018FundingValuation_FurValrun);
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select run>Future Valuation Liabilities for " + sNode_Funding_2018FundingValuation_FurValrun);
            ...
            //pMain._FlowTreeRightSelect(dic);
            _gLib._MsgBox("Manual Setting", "plese select View output for" + sNode_Funding_2018FundingValuation_FurValrun);
            ...
            dic.Add("Name", sService_Accounting_2019FutVal);
            ...
            dic.Add("PopVerify", "Pop");
            dic.Add("AddServiceInstance", "");
            dic.Add("ServiceToOpen", sService_Accounting_2019FutVal);
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Accounting_2019FutVal);
            ...
            dic.Clear();
            dic.Add("PopVerify", "Pop");
            dic.Add("ValNodeName", "Future Val Run_2019testing");
