...
{
    /// <summary>
    /// Summary description for _CA001_DNT
    /// </summary>
    [CodedUITest]
    public class _CA001_DNT
    {
        public _CA001_DNT()
        {
        ...
        public void test__CA001_DNT()
        {

            #region MultiThreads

            Thread thrd_Funding_WindUpGL2011 = new Thread(() => new _CA001_DNT().t_CompareRpt_Funding_WindUpGL2011(sOutputFunding_WindUpGL2011));
