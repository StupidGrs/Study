...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    /// </summary>
    [CodedUITest]
    public class _DE008_CN
    {
        public _DE008_CN()
        {
            Config.eEnv = _TestingEnv.QA2;
            Config.eCountry = _Country.DE;
            //Config.sClientName = "QA DE Benchmark 008 Create New_20190301";
        ...
        public void _test_DE008_CN()
        {
            ...
            //Thread thrd_Conversion2009 = new Thread(() => new _DE008_CN().t_CompareRpt_Conversion2009(sOutputPension_Conversion2009));
            //Thread thrd_Stichtag2010_Baseline = new Thread(() => new _DE008_CN().t_CompareRpt_Stichtag2010_Baseline(sOutputPension_Stichtag2010_Baseline));
            //Thread thrd_Stichtag2010_PreliminaryAssumptions = new Thread(() => new _DE008_CN().t_CompareRpt_Stichtag2010_PreliminaryAssumptions(sOutputPension_Stichtag2010_PreliminaryAssumptions));
            Thread thrd_Stichtag2011_Baseline = new Thread(() => new _DE008_CN().t_CompareRpt_Stichtag2011_Baseline(sOutputPension_Stichtag2011_Baseline));
            Thread thrd_Stichtag2011_InterestSensitivityPLUS = new Thread(() => new _DE008_CN().t_CompareRpt_Stichtag2011_InterestSensitivityPLUS(sOutputPension_Stichtag2011_InterestSensitivityPLUS));

            #endregion

            //this.GenerateReportOuputDir();

            string sService_Stichtag2011 = "Stichtag 2011-" + _gLib._ReturnDateStampYYYYMMDD();


            sOutputPension_Stichtag2011_Baseline = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_008\CreateNew\Val\Stichtag 2011\Baseline\";
            sOutputPension_Stichtag2011_InterestSensitivityPLUS = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_008\CreateNew\Val\Stichtag 2011\Interest Sensitivity PLUS0.5%\20190428_QA2\";
            sOutputPension_Stichtag2011_InterestSensitivityMINUS = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_008\CreateNew\Val\Stichtag 2011\Interest Sensitivity MINUS0.5%\20190428_QA2\";
            ...
            dic.Add("Name", sService_Stichtag2011);
            ...
            dic.Add("ServiceToOpen", sService_Stichtag2011);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Stichtag2011);
            ...
            //////dic.Add("ReportTemplate", "2016_DEDirectPromise");
            ...
            //////    dic.Clear();
            //////    dic.Add("PopVerify", "Pop");
            //////    dic.Add("InformationByBreak", "Trade Results level of Detail");
            //////    dic.Add("iCol", i.ToString());
            //////    dic.Add("sData", "Results with complete reconciliation of pension expense");
            //////    dic.Add("sFieldType", "LIST");
            //////    pActuarialReport._TaxAndTrade_TBL(dic, true);
            //////}
            ...
            //////////////////dic.Add("InformationByBreak", "Payments paid (incl. from assets, lump sum, divorcee)");
            //////////////////dic.Add("iCol", "1");
            //////////////////dic.Add("sData", "541996,49");
            //////////////////dic.Add("sFieldType", "txt");
            //////////////////pActuarialReport._TaxAndTrade_TBL(dic, true);

            //////_gLib._MsgBoxYesNo("", "\"Payments paid (incl. from assets, lump sum, divorcee)\" first data = 541996,49");
            //////_gLib._MsgBoxYesNo("", "Set the focuse at first column");
