...
{
    /// <summary>
    /// Summary description for _DE003_DNT
    /// </summary>
    [CodedUITest]
    public class _DE003_DNT
    {
        public _DE003_DNT()
        {
        ...
        public string sOutputPension_Pension2009_InterestSensitivity56_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\InterestSensitivity 5.6%\000_7.4_Baseline\";
        public string sOutputPension_Pension2009_InterestSensitivity66_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\InterestSensitivity 6.6%\000_7.4_Baseline\";
        public string sOutputPension_Pension2009_PaySensitivity25_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\PaySensitivity 2.5%\000_7.4_Baseline\";
        public string sOutputPension_Pension2009_PaySensitivity35_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\PaySensitivity 3.5%\000_7.4_Baseline\";
        public string sOutputPension_Pension2009_PensionSensitivity15_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\PensionSensitivity 1.5%\000_7.4_Baseline\";
        public string sOutputPension_Pension2009_PensionSensitivity25_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Pension\Valuation2009\PensionSensitivity 2.5%\000_7.4_Baseline\";
        public string sOutputJubilee_Jubilee2009_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_003\Existing\Val\Jubilee\Jubilee2009\000_7.4_Baseline\";
        ...
        public void _test_DE003_DNT()
        {
         

            #region MultiThreads

            Thread Thrd_Pension2009_InterestSensitivity56 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_InterestSensitivity56(sOutputPension_Pension2009_InterestSensitivity56));
            Thread Thrd_Pension2009_InterestSensitivity66 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_InterestSensitivity66(sOutputPension_Pension2009_InterestSensitivity66));
            Thread Thrd_Pension2009_PaySensitivity25 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_PaySensitivity25(sOutputPension_Pension2009_PaySensitivity25));
            Thread Thrd_Pension2009_PaySensitivity35 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_PaySensitivity35(sOutputPension_Pension2009_PaySensitivity35));
            Thread Thrd_Pension2009_PensionSensitivity15 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_PensionSensitivity15(sOutputPension_Pension2009_PensionSensitivity15));
            Thread Thrd_Pension2009_PensionSensitivity25 = new Thread(() => new _DE003_DNT().t_CompareRpt_Pension2009_PensionSensitivity25(sOutputPension_Pension2009_PensionSensitivity25));
        ...
        public void t_CompareRpt_Pension2009_InterestSensitivity56(string sOutputPension_Pension2009_InterestSensitivity56)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_InterestSensitivity56_Prod, sOutputPension_Pension2009_InterestSensitivity56);
        ...
        public void t_CompareRpt_Pension2009_InterestSensitivity66(string sOutputPension_Pension2009_InterestSensitivity66)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_InterestSensitivity66_Prod, sOutputPension_Pension2009_InterestSensitivity66);
        ...
        public void t_CompareRpt_Pension2009_PaySensitivity25(string sOutputPension_Pension2009_PaySensitivity25)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_PaySensitivity25_Prod, sOutputPension_Pension2009_PaySensitivity25);
        ...
        public void t_CompareRpt_Pension2009_PaySensitivity35(string sOutputPension_Pension2009_PaySensitivity35)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_PaySensitivity35_Prod, sOutputPension_Pension2009_PaySensitivity35);
        ...
        public void t_CompareRpt_Pension2009_PensionSensitivity25(string sOutputPension_Pension2009_PensionSensitivity25)
        {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("DE003DNT", sOutputPension_Pension2009_PensionSensitivity25_Prod, sOutputPension_Pension2009_PensionSensitivity25);
