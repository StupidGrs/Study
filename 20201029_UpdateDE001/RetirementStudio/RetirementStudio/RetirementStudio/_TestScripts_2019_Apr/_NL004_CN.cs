...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _NL004_CN
    {
        ...
        public string sOutputAccounting_Conversion2011_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_NL_Benchmark_004\Existing\Valuation 2012\Baseline\000_7.4_Baseline\";
        ...
        public void _test_NL004_CN()
        {

            string sServiceVal = "Valuation 2012-20190808";
             

            #region MultiThreads

            //Thread thrd_Conversion2011 = new Thread(() => new _NL004_CN().t_CompareRpt_Conversion2011(sOutputAccounting_Conversion2011));
            Thread thrd_Valuation2012_Baseline = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_Baseline(sOutputAccounting_Valuation2012_Baseline));
            Thread thrd_Valuation2012_IndexationSensitivity125 = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_IndexationSensitivity125(sOutputAccounting_Valuation2012_IndexationSensitivity125));
            Thread thrd_Valuation2012_InterestSensitivity585 = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_InterestSensitivity585(sOutputAccounting_Valuation2012_InterestSensitivity585));
            Thread thrd_Valuation2012_InterestSensitivity535 = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_InterestSensitivity535(sOutputAccounting_Valuation2012_InterestSensitivity535));
            Thread thrd_Valuation2012_PaySensitivity325 = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_PaySensitivity325(sOutputAccounting_Valuation2012_PaySensitivity325));
            Thread thrd_Valuation2012_PaySensitivity375 = new Thread(() => new _NL004_CN().t_CompareRpt_Valuation2012_PaySensitivity375(sOutputAccounting_Valuation2012_PaySensitivity375));
            ...
            #region Valuation 2012 - Roll Forward
            ...
            dic.Add("ServiceToOpen", sServiceVal);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);

            pMain._SelectTab(sServiceVal);
