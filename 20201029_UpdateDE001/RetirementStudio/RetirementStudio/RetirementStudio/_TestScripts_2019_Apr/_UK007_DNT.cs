...
{
    /// <summary>
    /// Summary description for _UK007_DNT
    /// </summary>
    [CodedUITest]
    public class _UK007_DNT
    {
        public _UK007_DNT()
        {
        ...
        {
            ////sOutputFunding_Valuation2017_DefsAndPens = @"R:\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_007\Small client\Existing\Funding\Defs and Pens\20190708_QA2\";
            ////sOutputFunding_Valuation2017_DefsAndPens_Prod = @"R:\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_007\Small client\Existing\Funding\Defs and Pens\20190530_QA2\";
            ////sOutputFunding_Valuation2017_ActiveMales_Prod = @"R:\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_007\Small client\Existing\Funding\Active Males\20190530_QA2\";
            ////sOutputFunding_Valuation2017_ActiveMales = @"R:\RETIRE_STUDIO_BENCHMARK REPORTS\QA_UK_Benchmark_007\Small client\Existing\Funding\Active Males\20190708_QA2\";
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Parameter Print", "RollForward", true, true);
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Liability Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Member Statistics", "RollForward", false, true);
            pOutputManager._ExportReport_DrillDown(sOutputFunding_Valuation2017_DefsAndPens, "Conversion Diagnostic", "RollForward", false, true, 0);
            pOutputManager._ExportReport_Common(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Detailed Results", "RollForward", false, true);
            pOutputManager._ExportReport_Others(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Detailed Results with Ben Type splits", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Valuation Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "2D PayoutProjections", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Reconciliation to Baseline", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Liabilities Detailed Results", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_DefsAndPens, "Liabilities Detailed Results with Ben Type splits", "RollForward", false, true);
            ...
            if (Config.bCompareReports)
            {
                ...
                _compareReportsLib.CompareExcel_Exact("2DPayoutProjections.xlsx", 4, 0, 0, 0);
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "Parameter Print", "RollForward", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "Valuation Summary", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "2D PayoutProjections", "RollForward", false, true);
            pOutputManager._ExportReport_SubReports_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "Reconciliation to Baseline", "RollForward", false, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "Liabilities Detailed Results", "RollForward", false, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_Valuation2017_ActiveMales, "Liabilities Detailed Results with Ben Type splits", "RollForward", false, true);
