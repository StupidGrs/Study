...
{
    /// <summary>
    /// Summary description for _BR004_CN
    /// </summary>
    [CodedUITest]
    public class _BR004_CN
    {
        public _BR004_CN()
        {
        ...
        public void Test_BR004_CN()
        {
            ...
            sService_Accounting = "Acc2015_20190812";
            sService_Funding = "Fnd2015_20190812";



            #region MultiThreads

            Thread thrd_Accounting2015 = new Thread(() => new _BR004_CN().t_CompareRpt_Valuation2011_Baseline(sAccounting_Accounting2015));
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sAccounting_Accounting2015, "Valuation Summary", "Conversion", true, false);
            ...
            #region Funding -  ParticipantData
            ...
            #region Funding  - Methods & Run & Reports
            ...
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("_BR004CN", sFunding_Funding2015_Prod, sFunding_Funding2015);
       ...
       
         {
            if (Config.bCompareReports)
            {
                CompareReportsLib _compareReportsLib = new CompareReportsLib("_BR004CN", sAccounting_Accounting2015_Prod, sAccounting_Accounting2015);
