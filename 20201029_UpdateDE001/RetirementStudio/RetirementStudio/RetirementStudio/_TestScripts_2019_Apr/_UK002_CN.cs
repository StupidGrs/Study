...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _UK002_CN
    {
        ...
        public string sService_Funding_QAUK002Val = "";
        ...
        public void _test_UK002_CN()
        {

            sService_Funding_QAUK002Val = "QA UK 002 VAl 2019 -20190926";


            this.GenerateReportOuputDir();


            #region   Funding - QA UK 002 Val_2019testing - ParticipantData
            ...
            dic.Add("Name", sService_Funding_QAUK002Val);
            dic.Add("Parent", "");
            ...
            dic.Add("ServiceToOpen", sService_Funding_QAUK002Val);
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Funding_QAUK002Val);
            ...
            #region Funding - QA UK 002 Val_2019testing - Assumptions & Provisions
            ...
            #region Funding - QA UK 002 Val_2019testing - Methods
            ...
            #region Funding - QA UK 002 Val_2019testing - Test case
            ...
            #region Funding - QA UK 002 Val_2019testing - Rseports
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUK002Val, "Liability Summary", "Conversion", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUK002Val, "Member Statistics", "Conversion", true, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(sOutputFunding_QAUK002Val, "Conversion Diagnostic", "Conversion", true, true, 0);
            pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUK002Val, "Valuation Summary", "Conversion", true, true);
            pOutputManager._ExportReport_Others_PDF_EXCEL(Config.eCountry, sOutputFunding_QAUK002Val, "Individual Output", "Conversion", true, true);
