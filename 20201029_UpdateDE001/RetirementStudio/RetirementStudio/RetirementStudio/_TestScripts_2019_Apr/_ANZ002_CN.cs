...
{
    /// <summary>
    /// Summary description for _ANZ002_CN
    /// </summary>
    [CodedUITest]
    public class _ANZ002_CN
    {
        public _ANZ002_CN()
        {
        ...
        public void _test_ANZ002_CN()
        {

            //this.GenerateReportOuputDir();


            sOutputFunding_2014BenchmarkVal_REVISED50YearsFV = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_BM_ANZ_002\CreateNew\Funding2014\Revised50YearsFV\20190829_QA1\";
            ...
            //dic.Clear();
            //dic.Add("PopVerify", "Pop");
            //dic.Add("ValNodeName", "Test_REVISED50YearFV");
            ...
            //pOutputManager._PopVerify_OutputManager(dic);
                ...
                pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_2014BenchmarkVal_REVISED50YearsFV, "Future Valuation Population Projection", "Conversion", false, true);
                pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_2014BenchmarkVal_REVISED50YearsFV, "Future Valuation Summary", "Conversion", false, true);
                pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_2014BenchmarkVal_REVISED50YearsFV, "Future Valuation Liabilities by Group", "Conversion", false, true);
                pOutputManager._ExportReport_Common_PDF_EXCEL(Config.eCountry, sOutputFunding_2014BenchmarkVal_REVISED50YearsFV, "Future Valuation Liabilities by Year", "Conversion", false, true);
                pOutputManager._ExportReport_FVPayouts_PDF_EXCEL(Config.eCountry, sOutputFunding_2014BenchmarkVal_REVISED50YearsFV, "Conversion", false, true);
