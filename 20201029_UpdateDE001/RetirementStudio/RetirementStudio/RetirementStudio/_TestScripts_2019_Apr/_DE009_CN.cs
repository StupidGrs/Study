...
namespace RetirementStudio._TestScripts_2019_Apr
{
    ...
    public class _DE009_CN
    {
        ...
        public void _test_DE009_CN()
        {

            string sService_Conversion2010 = "Conversion 2010-" + _gLib._ReturnDateStampYYYYMMDD();


            pMain._SetLanguageAndRegional();


            sOutputPension_Conversion2010 = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_009\CreateNew\Conversion 2010\20190526_QA2\";
            sOutputPension_Conversion2010_Prod = @"\\mercer.com\US_Data\Shared\Dfl\Data1\RSS\SQA\RETIRE_STUDIO_BENCHMARK REPORTS\QA_DE_Benchmark_009\Existing\Conversion 2010\000_7.4_Baseline\";
            ...
            dic.Add("Name", sService_Conversion2010);
            dic.Add("Parent", "");
            ...
            dic.Add("ServiceToOpen", sService_Conversion2010);
            dic.Add("CheckPopup", "False");
            pMain._PopVerify_Home_RightPane(dic);


            pMain._SelectTab(sService_Conversion2010);
            ...
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputPension_Conversion2010, "Detailed Results by Plan Def", "Conversion", true, true);
            pOutputManager._ExportReport_Common_PDF_EXCEL(sOutputPension_Conversion2010, "Valuation Summary", "Conversion", true, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Valuation Summary", "Conversion", true, false, 0, new string[5] { "HerrDrHille", "HerrLinicus", "HerrProfDrGrebe", "HerrProfDrPiper", "HerrDrRurup" });
            ...
            pOutputManager._ExportReport_Others_PDF_EXCEL(sOutputPension_Conversion2010, "IOE", "Conversion", true, true);
            pOutputManager._ExportReport_DrillDown_PDF_EXCEL(Config.eCountry, sOutputPension_Conversion2010, "Member Statistics", "Conversion", true, false, 0, new string[5] { "HerrDrHille", "HerrLinicus", "HerrProfDrGrebe", "HerrProfDrPiper", "HerrDrRurup" });
            ...
            #region PensionValuations - Conversion2010 - CompareReports
