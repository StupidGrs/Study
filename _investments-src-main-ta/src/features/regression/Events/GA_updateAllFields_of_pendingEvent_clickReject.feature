@events
Feature: Global Admin updates all fields of Pending Event and clicks [Reject] / [Reject and open the next] button
...
#    And User clicks Remove Featured Image button "moderateEventPage|eventRemoveFeaturedImageButton"
  ...
  Scenario: Global Admin updates all fields, clicks [Reject] button and verifies that values are not changed
    And User clicks [Reject] button "moderateEventPage|rejectButton"
    And User clicks [Reject] button on Reject Popup "moderateEventPage|rejectPopupRejectButton"
    ...
    And User enters "$eventTitle" in Search Content field "contentListPage|searchContentField"
    #Verify that changes made by Admin are not applied (event title is not changed), because event has been Rejected
    ...
    And Event Type "moderateEventPage|eventTypeDropdownField" input contains "Webinar" text
...
#    And Remove Featured image button "moderateEventPage|eventRemoveFeaturedImageButton" is enabled
  ...
  Scenario: Global Admin updates all fields, clicks [Reject and open the next] button and verifies that values are not changed
    When User clicks [Reject and open the next] button "moderateEventPage|rejectAndOpenNextButton"
    And User clicks [Reject] button on Reject Popup "moderateEventPage|rejectPopupRejectButton"
    ...
    And Attribute "value" of Title field "moderateEventPage|titleField" is not equal to "$eventTitle"
