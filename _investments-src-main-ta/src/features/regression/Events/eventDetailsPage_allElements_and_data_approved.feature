@events
@eventDetails
Feature: Verify elements and data on Event Details Page - Approved

    @regression
    Scenario: Verify Details page of Approved Event with all fields
...
#        And Attribute "style" of Event Featured Image "eventDetailsPage|headerFeaturedImage" does not contain "default-feature-image.png"
    ...
    @regression
    Scenario: Verify Details page of Approved Event with required fields only
