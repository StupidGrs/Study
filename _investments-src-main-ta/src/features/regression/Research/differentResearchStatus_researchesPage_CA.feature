@research
Feature: [Company Admin] verifies Research availability on Research page
    ...
    @smoke
    @regression
    Scenario: [Company Admin] Verify Research is NOT available on Researches page with status: Draft
    ...
    @smoke
    @regression
    Scenario: [Company Admin] Verify Research is NOT available on Researches page with status: Pending
    ...
    @smoke
    @regression
    Scenario: [Company Admin] Verify Research is available on Researches page with status: Approved
        When User "COMPANY_ADMIN" publishes "Research" with title "$researchTitle" with API
    ...
    @smoke
    @regression
    Scenario: [Company Admin] Verify Research is NOT available on Researches page with status: Rejected
        When User "COMPANY_ADMIN" publishes "Research" with title "$researchTitle" with API
        Then User "GLOBAL_ADMIN" logs in with API
