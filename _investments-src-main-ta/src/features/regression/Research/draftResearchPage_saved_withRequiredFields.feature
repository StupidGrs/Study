@research
Feature: Verify all elements and fields on Draft Research Page, when Research saved with required fields only
    ...
    @regression
    @draftResearchPage
    Scenario: Verify Draft Research Page, when Research saved with required fields only
        #Header
