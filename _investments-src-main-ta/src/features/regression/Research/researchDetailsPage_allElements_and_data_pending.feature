@research
@researchDetails
Feature: Verify elements and data on Research Details Page - Pending

    @regression
    @knownIssue @SRC-1369
    Scenario: Verify Details page of Pending Research with all fields
...
#        And Attribute "href" of [Download the full report] button "researchDetailsPage|downloadFullReportButton" contains ".pdf"
        ...
        And Star Icon "researchDetailsPage|leftBlockRateThisStarIcon" is not displayed
        And Rate This text "researchDetailsPage|leftBlockRateThisText" is not displayed
        And Bookmark Icon "researchDetailsPage|leftBlockBookmarkIcon" is not displayed
...
#        And Attribute "href" of Download Attachment link "researchDetailsPage|leftBlockDownloadAttachLink" contains ".pdf"
        ...
        And Rate This text "researchDetailsPage|footerRateThisText" is not displayed
    ...
    @regression
    Scenario: Verify Detials page of Pending Research with required fields only
