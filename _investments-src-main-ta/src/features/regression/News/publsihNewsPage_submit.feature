@news
Feature: Company Admin creates News with [Submit] button
  ...
  Background:
    ...
    And Submit button "publishNewsPage|submitButton" is displayed

  @regression
  @publishNewsPage
  Scenario: Company Admin submits News with all fields populated
