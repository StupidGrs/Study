@companyContentClickthroughs
Feature: Company Admin verifies Clickthroughs counter on Company Content page

  @regression
  Scenario Outline: Company Admin verifies Clickthroughs Counter for Researches in <tab_name> tab by clicking Visit External Link
    #precondition
    ...
    And Clickthroughs Counter "companyContent|clickthroughsCell" text is equal to "0"
    ...
    And User clicks Visit External Link "researchDetailsPage|visitExternalLinkButton"
    When User clicks Back button "researchDetailsPage|backButton" by executing script
    And User enters "$researchTitle" in Search Field "companyContent|searchField"
    And User clicks <tab_name> tab "companyContent|<selector>"
    Then Post Name "companyContent|postNameCell" with text "$researchTitle" is displayed
    And Clickthroughs Counter "companyContent|clickthroughsCell" text is equal to "<number>"
    #postcondition
  ...
  Scenario Outline: Company Admin verifies Clickthroughs Counter for Researches in <tab_name> tab by clicking Visit External Link
    ...
    And User clicks <tab_name> tab "companyContent|<selector>"
    Then Post Name "companyContent|postNameCell" with text "$researchTitle" is displayed
    And Clickthroughs Counter "companyContent|clickthroughsCell" with text "<number>" is displayed
    #postcondition
    And User deletes "Research" with "Title" equal to "$researchTitle"
    Examples:
      |action      |tab_name        |selector            |number|
  ...
  @regression
  Scenario Outline: Company Admin verifies Clickthroughs Counter for News Items in <tab_name> tab by clicking Read Full Article
    #precondition
    When User "COMPANY_ADMIN" logs in with API
    ...
    And User clicks Read Full Article "newsDetailsPage|readFullButtonLink"
  ...
  @regression
  Scenario Outline: Company Admin verifies Clickthroughs Counter for Events in <tab_name> tab by clicking Tickets & Info
    #precondition
    When User "COMPANY_ADMIN" logs in with API
    ...
    And User clicks Tickets & Info "eventDetailsPage|ticketsButton"
