...
let td_content = {
    ...
    "Title": '2512_AutoEvent_extNormal_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify External User check normal ' + td_content.ArticleType, function () {
    ...
    describe('Verify Mercer Admin check normal ' + td_content.ArticleType + ' on ' + td_content.ArticleType + ' page', function () {
        ...
        it('AND: I see the normal ' + td_content.ArticleType + ' in ' + td_content.ArticleType + ' page: ' + td_content.Title, function () {
