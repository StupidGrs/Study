...
let td_content = {
    ...
    "Title": '0_AutoNews_Rejected_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify SRC publisher check file upload with different document types on Posts - rejected news page', function () {

    it('PREPARE TEST DATA', function () {
        fcommon_test.__GivenTheUserHasLoginSRC(td_user.compAuthor)
        fcommon_test.__UserSubmitAnArticleOnPublishPageWithMandatoryFields(td_content, false)
    ...
    it('THEN I see Posts - News draft opened - ' + td_content.Title, function () {
