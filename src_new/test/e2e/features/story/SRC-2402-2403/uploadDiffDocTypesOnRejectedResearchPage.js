...
let td_content = {
    ...
    "Title": '0_AutoResearch_Rejected_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify SRC publisher check file upload with different document types on Posts - rejected research page', function () {

    it('PREPARE TEST DATA', function () {
        fcommon_test.__GivenTheUserHasLoginSRC(td_user.compAuthor)
        fcommon_test.__UserSubmitAnArticleOnPublishPageWithMandatoryFields(td_content, true)
    ...
    it('THEN I see Posts - Research draft opened' + td_content.Title, function () {
