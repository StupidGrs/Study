...
let td_content = {
    ...
    "Title": '0_AutoNews_Diff_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify SRC Admin check file upload with different document types', function () {

    it('BACKGROUND: User login as: ' + td_user.globalAdmin, function () {
        fcommon_test.__GivenTheUserHasLoginSRC(td_user.globalAdmin)
    })

    describe('Verify SRC Admin check file upload with different document types on Publish News page', function () {

        it('WHEN I open SRC publish News page', function () {
            pcommon_publish.__Publish(td_article.news)
        })

        it('THEN I see a file upload dropzone', function () {
            fcommon_obj.__ElementPresent("_zoneUploadAttachment_clickable", pcommon_publish._zoneUploadAttachment_clickable);
    ...
    describe('Verify SRC Admin check file upload with different document types on Draft News page', function () {

        it('WHEN I open Posts - draft News - ' + td_content.Title, function () {
    ...
    describe('Verify SRC Admin check file upload with different document types on Pending News page', function () {

        it('WHEN I open Moderate List - Pending News - ' + td_content.Title, function () {
            pcommon_page.__gotoSetting('Moderate Content');
            pcontentList.__doSearch('Waiting for approval', td_posts.news, td_content.Title, true);
        })

        it('THEN I see a file upload dropzone', function () {
            fcommon_obj.__ElementPresent("_zoneUploadAttachment_clickable", pcommon_moderate._zoneUploadAttachment_clickable);
    ...
    describe('Verify SRC Admin check file upload with different document types on Approved News page', function () {

        it('WHEN I open Moderate List - Approved News - ' + td_content.Title, function () {
            pcommon_page.__gotoSetting('Moderate Content');
            pcontentList.__doSearch('Waiting for approval', td_posts.news, td_content.Title, false);
            pcontentList.__doApproveReject(td_content.Title, true);
            pcontentList.__doSearch('Approved', td_posts.news, td_content.Title, true);
        })
    ...
    describe('Verify SRC Admin check file upload with different document types on Rejected News page', function () {

        it('WHEN I open Moderate List - Approved News - ' + td_content.Title, function () {
            pcommon_page.__gotoSetting('Moderate Content')
            pcontentList.__doSearch('Approved', td_posts.news, td_content.Title, false)
            pcontentList.__doApproveReject(td_content.Title, false)
            pcontentList.__doSearch('Rejected', td_posts.news, td_content.Title, true)
        })
