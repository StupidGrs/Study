...
describe('Verify SRC publisher check file upload with different document types on publish research page', function () {

    it('WHEN User login as: ' + td_user.compAuthor, function () {
        fcommon_test.__GivenTheUserHasLoginSRC(td_user.compAuthor)
    })

    it('THEN I see SRC publish Research opened', function () {
