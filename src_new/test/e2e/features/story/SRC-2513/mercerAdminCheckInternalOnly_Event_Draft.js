...
let td_content_draft = {
    ...
    "Title": '2513_AutoEvent_draft_' + futil_timer.__returnYYYYMMDDHMS(),
...
let td_content_internalonly_draft = {
    ...
    "Title": '2513_AutoEvent_InternalOnly_draft_' + futil_timer.__returnYYYYMMDDHMS(),
    "ExecutiveSummary": 'This is ExecutiveSummary: ' + futil_timer.__returnYYYYMMDDHMS(),
    "URL": 'https://colleagueconnect.mmc.com/en-us/Pages/HomePage.aspx',
    "Content": 'This is Event Content: ' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify Mercer Admin check Internal Only - draft Internal-Only Event page', function () {

    it('WHEN: I see an Internal-Only draft Event opened: ' + td_content_internalonly_draft.Title, function () {
    ...
    it('AND: I see the other fields not affected', function () {
        ...
        fcommon_test.__checkElement_containValue(pcommon_publish._lstEventType, td_content_internalonly_draft.Type)
        fcommon_test.__checkElement_containValue(pcommon_publish._txtLocation, td_content_internalonly_draft.Location)
...
describe('Verify Mercer Admin check Internal Only - draft normal Event page', function () {

    it('WHEN: I see the draft Event page opened: ' + td_content_draft.Title, function () {
    ...
    it('AND: I see all the saved fields are correct', function () {
        ...
        fcommon_test.__checkElement_containValue(pcommon_publish._lstEventType, td_content_draft.Type)
        fcommon_test.__checkElement_containValue(pcommon_publish._txtLocation, td_content_draft.Location)
        // fcommon_test.__checkElement_isDisplayed(pcommon_publish._zoneFeaturedImage_delete, true)
