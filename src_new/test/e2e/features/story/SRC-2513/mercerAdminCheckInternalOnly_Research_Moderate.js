...
let td_content_moderate = {
    ...
    "Title": '2513_AutoResearch_moderate_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify Mercer Admin check Internal Only - moderate Research page', function () {

    it('WHEN: I see the moderate Research page opened', function () {
