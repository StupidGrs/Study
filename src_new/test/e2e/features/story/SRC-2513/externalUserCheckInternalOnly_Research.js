...
let td_content = {
    ...
    "Title": '2513_AutoResearch_External_' + futil_timer.__returnYYYYMMDDHMS(),
    ...
    describe('Verify External User check Internal Only - publish Research page', function () {

        it('WHEN: External User login as: ' + td_user.compAuthor, function () {
            fcommon_test.__GivenTheUserHasLoginSRC(td_user.compAuthor)
        })

        it('AND: I see the publish News page opened', function () {
    ...
    describe('Verify External User check Internal Only - draft Research page', function () {

        it('WHEN: I see a draft Research opened: '+td_content.Title, function () {
