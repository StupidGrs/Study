...
let td_content = {
    ...
    "Title": '2513_AutoNews_External_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify External User check Internal Only - publish News page', function () {
...
describe('Verify External User check Internal Only - draft News page', function () {

    it('WHEN: I see a draft News opened: '+td_content.Title, function () {
