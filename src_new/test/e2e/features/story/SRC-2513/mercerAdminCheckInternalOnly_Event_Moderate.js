...
let td_content_moderate = {
    ...
    "Title": '2513_AutoEvent_moderate_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify Mercer Admin check Internal Only - moderate Event page', function () {

    it('WHEN: I see the moderate Event page opened: ' + td_content_moderate.Title, function () {
