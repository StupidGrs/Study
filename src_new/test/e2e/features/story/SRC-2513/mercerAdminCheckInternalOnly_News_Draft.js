...
let td_content_draft = {
    ...
    "Title": '2513_AutoNews_draft_' + futil_timer.__returnYYYYMMDDHMS(),
...
let td_content_internalonly_draft = {
    ...
    "Title": '2513_AutoNews_InternalOnly_draft_' + futil_timer.__returnYYYYMMDDHMS(),
    "ExecutiveSummary": 'This is ExecutiveSummary: ' + futil_timer.__returnYYYYMMDDHMS(),
    "URL": 'https://colleagueconnect.mmc.com/en-us/Pages/HomePage.aspx',
    "Content": 'This is News Content: ' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify Mercer Admin check Internal Only - draft Internal-Only News page', function () {

    it('WHEN: I see an Internal-Only draft News opened: ' + td_content_internalonly_draft.Title, function () {
...
describe('Verify Mercer Admin check Internal Only - draft normal News page', function () {

    it('WHEN: I see the draft News page opened: ' + td_content_draft.Title, function () {
