...
let td_content = {
    ...
    "Title": '2513_AutoResearch_InternalOnly_publish_' + futil_timer.__returnYYYYMMDDHMS(),
...
describe('Verify Mercer Admin check Internal Only - publish Research page', function () {

    describe('Verify Mercer Admin check Internal Only - publish Research page - default page', function () {

        it('WHEN: I see the publish Research page opened', function () {
        ...
        it('AND: I see the other fields are empty', function () {
            ...
            fcommon_test.__checkElement_textValue(pcommon_publish._lstResearchType, '')
    ...
    describe('Verify Mercer Admin check Internal Only - publish Research page - set Internal Only', function () {
    ...
    describe('Verify Mercer Admin check Internal Only - publish Research page - set back to no Internal Only', function () {
    ...
    describe('Verify Mercer Admin check Internal Only - publish Research page - input some setting and set Internal Only', function () {
        ...
        it('AND: I see the other fields not affected', function () {
            ...
            fcommon_test.__checkElement_containValue(pcommon_publish._lstResearchType, td_content.Type)
            fcommon_test.__checkElement_textValue(pcommon_publish._txtNumOfMins, td_content.NumOfMins)
            fcommon_test.__checkElement_textValue(pcommon_publish._txtVideoEmbed, td_content.VideoLink)
    ...
    describe('Verify Mercer Admin check Internal Only - publish Research page - set Internal Only then Submit & Add Another Article', function () {
