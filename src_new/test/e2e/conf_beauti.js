...
exports.config = {
    ...
    suites: {
        api: [
            './features/api_testing/api_sample.js',
        ],
    ...
    capabilities: {
        ...
        browserName: 'chrome',
        chromeOptions: {
            args: ['--disable-extensions', '--start-maximized', "--incognito", "--allow-insecure-localhost", '--disable-web-security', "--allow-running-insecure-content"],
    ...
    onPrepare: function () {
        ...
        jasmine.getEnv().addReporter(new HtmlReporter({
            ...
            docTitle: 'SRC_Automation_Report',
            docName: 'index.html',
